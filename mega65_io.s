...
YSCL_MASK = %00000111  ; 24/25 vertical smooth scroll (bit mask)
...
RSEL_MASK = %00001000  ; 24/25 row select (bit mask)
...
ECM_MASK = %01000000  ; extended background mode (bit mask)
...
RC_MASK = %10000000  ; raster compare bit 8 (bit mask)
...
XSCL_MASK = %00000111  ; horizontal smooth scroll (bit mask)
...
CSEL_MASK = %00001000  ; 38/40 column select (bit mask)
...
MCM_MASK = %00010000  ; Multi-colour mode (bit mask)
...
CB_MASK = %00001110  ; character set address location ($\times$ 1KiB) (bit mask)
...
VS_MASK = %11110000  ; screen address ($\times$ 1KiB) (bit mask)
...
RIRQ_MASK = %00000001  ; raster compare indicate or acknowledge (bit mask)
...
ISBC_MASK = %00000010  ; sprite:bitmap collision indicate or acknowledge (bit mask)
...
ISSC_MASK = %00000100  ; sprite:sprite collision indicate or acknowledge (bit mask)
...
ILP_MASK = %00001000  ; light pen indicate or acknowledge (bit mask)
...
MRIRQ_MASK = %00000001  ; mask raster IRQ (bit mask)
...
MISBC_MASK = %00000010  ; mask sprite:bitmap collision IRQ (bit mask)
...
MISSC_MASK = %00000100  ; mask sprite:sprite collision IRQ (bit mask)
...
C128_FAST_MASK = %00000001  ; 2MHz select (for C128 2MHz emulation) (bit mask)
...
CRAM2K_MASK = %00000001  ; Map 2nd KB of colour RAM @ $DC00-$DFFF (bit mask)
...
EXTSYNC_MASK = %00000010  ; Enable external video sync (genlock input) (bit mask)
...
PAL_MASK = %00000100  ; Use PALETTE ROM (0) or RAM (1) entries for colours 0 - 15 (bit mask)
...
ROM8_MASK = %00001000  ; Map C65 ROM @ $8000 (bit mask)
...
ROMA_MASK = %00010000  ; Map C65 ROM @ $A000 (bit mask)
...
ROMC_MASK = %00100000  ; Map C65 ROM @ $C000 (bit mask)
...
CROM9_MASK = %01000000  ; Select between C64 and C65 charset. (bit mask)
...
ROME_MASK = %10000000  ; Map C65 ROM @ $E000 (bit mask)
...
INT_MASK = %00000001  ; Enable VIC-III interlaced mode (bit mask)
...
MONO_MASK = %00000010  ; Enable VIC-III MONO video output (not implemented) (bit mask)
...
H1280_MASK = %00000100  ; Enable 1280 horizontal pixels (not implemented) (bit mask)
...
V400_MASK = %00001000  ; Enable 400 vertical pixels (bit mask)
...
BPM_MASK = %00010000  ; Bit-Plane Mode (bit mask)
...
ATTR_MASK = %00100000  ; Enable extended attributes and 8 bit colour entries (bit mask)
...
FAST_MASK = %01000000  ; Enable C65 FAST mode (~3.5MHz) (bit mask)
...
H640_MASK = %10000000  ; Enable C64 640 horizontal pixels / 80 column mode (bit mask)
...
B0ADEVN_MASK = %00001110  ; Bitplane X address, even lines (bit mask)
...
TBDRPOS_MASK = %00001111  ; top border position MSB (bit mask)
...
BBDRPOS_MASK = %00001111  ; bottom border position (bit mask)
...
TEXTXPOS_MASK = %00001111  ; character generator horizontal position (bit mask)
...
TEXTYPOS_MASK = %00001111  ; Character generator vertical position (bit mask)
...
XPOSMSB_MASK = %00111111  ; Read horizontal raster scan position MSB (bit mask)
...
DBLRR_MASK = %01000000  ; When set, the Raster Rewrite Buffer is only updated every 2nd raster line, limiting resolution to V200, but allowing more cycles for Raster-Rewrite actions. (bit mask)
...
NORRDEL_MASK = %10000000  ; When clear, raster rewrite double buffering is used (bit mask)
...
FN_RASTER_MSB_MASK = %00000111  ; Read physical raster position (bit mask)
...
SHDEMU_MASK = %01000000  ; Enable simulated shadow-mask (PALEMU must also be enabled) (bit mask)
...
FNRST_MASK = %10000000  ; Raster compare source (0=VIC-IV fine raster, 1=VIC-II raster) (bit mask)
...
CHR16_MASK = %00000001  ; enable 16-bit character numbers (two screen bytes per character) (bit mask)
...
FCLRLO_MASK = %00000010  ; enable full-colour mode for character numbers <=$FF (bit mask)
...
FCLRHI_MASK = %00000100  ; enable full-colour mode for character numbers >$FF (bit mask)
...
SMTH_MASK = %00001000  ; video output horizontal smoothing enable (bit mask)
...
SPR640_MASK = %00010000  ; Sprite H640 enable; (bit mask)
...
PALEMU_MASK = %00100000  ; Enable PAL CRT-like scan-line emulation (bit mask)
...
VFAST_MASK = %01000000  ; C65GS FAST mode (48MHz) (bit mask)
...
ALPHEN_MASK = %10000000  ; Alpha compositor enable (bit mask)
...
SDBDRWD_MSB_MASK = %00111111  ; side border width (MSB) (bit mask)
...
RST_DELEN_MASK = %01000000  ; Enable raster delay (delays raster counter and interrupts by one line to match output pipeline latency) (bit mask)
...
HOTREG_MASK = %10000000  ; Enable VIC-II hot registers. When enabled, touching many VIC-II registers causes the VIC-IV to recalculate display parameters, such as border positions and sizes (bit mask)
...
SCRNPTRMB_MASK = %00001111  ; screen RAM precise base address (bits 31 - 24) (bit mask)
...
CHRCOUNT_MASK = %00110000  ; Number of characters to display per (bit mask)
...
EXGLYPH_MASK = %10000000  ; source full-colour character data from expansion RAM (bit mask)
...
SPRPTRBNK_MASK = %01111111  ; sprite pointer address (bits 23 - 16) (bit mask)
...
SPR_PTR16_MASK = %10000000  ; 16-bit sprite pointer mode (allows sprites to be located on any 64 byte boundary in chip RAM) (bit mask)
...
RASLINE0_MASK = %00111111  ; first VIC-II raster line (bit mask)
...
VGAHDTV_MASK = %01000000  ; Select more VGA-compatible mode if set, instead of HDMI/HDTV VIC-II cycle-exact frame timing. May help to produce a functional display on older VGA monitors. (bit mask)
...
PALNTSC_MASK = %10000000  ; NTSC emulation mode (max raster = 262) (bit mask)
...
ABTPALSEL_MASK = %00000011  ; VIC-IV bitmap/text palette bank (alternate palette) (bit mask)
...
SPRPALSEL_MASK = %00001100  ; sprite palette bank (bit mask)
...
BTPALSEL_MASK = %00110000  ; bitmap/text palette bank (bit mask)
...
MAPEDPAL_MASK = %11000000  ; palette bank mapped at $D100-$D3FF (bit mask)
...
ALPHADELAY_MASK = %00001111  ; Alpha delay for compositor (bit mask)
...
RASTERHEIGHT_MASK = %11110000  ; physical rasters per VIC-II raster (1 to 16) (bit mask)
...
RSTCMP_MASK = %00000111  ; Raster compare value MSB (bit mask)
...
SPTR_CONT_MASK = %00001000  ; Continuously monitor sprite pointer, to allow changing sprite data source while a sprite is being drawn (bit mask)
...
EXTIRQS_MASK = %01000000  ; Enable additional IRQ sources, e.g., raster X position. (bit mask)
...
FNRST_CMP_MASK = %10000000  ; Raster compare is in physical rasters if set, or VIC-II raster if clear (bit mask)
...
BIT_PBANK_MASK = %00000111  ; Set which 128KB bank bitplanes (bit mask)
...
HSYNCP_MASK = %00010000  ; hsync polarity (bit mask)
...
VSYNCP_MASK = %00100000  ; vsync polarity (bit mask)
...
DEBUGC_MASK = %11000000  ; VIC-IV debug pixel select red(01), green(10) or blue(11) channel visible in $D07D (bit mask)
...
DEBUGX_MASK = %00001111  ; VIC-IV debug X position (MSB) (bit mask)
...
DEBUGY_MASK = %11110000  ; VIC-IV debug Y position (MSB) (bit mask)
...
DEBUGOOF_MASK = %10000000  ; VIC-IV debug out-of-frame signal enable (bit mask)
...
DS_MASK = %00000111  ; Drive select (0 to 7). Internal drive is 0. Second floppy drive on internal cable is 1. Other values reserved for C1565 external drive interface. (bit mask)
...
SIDE_MASK = %00001000  ; Directly controls the SIDE signal to the floppy drive, i.e., selecting which side of the media is active. (bit mask)
...
SWAP_MASK = %00010000  ; Swap upper and lower halves of data buffer (i.e. invert bit 8 of the sector buffer) (bit mask)
...
MOTOR_MASK = %00100000  ; Activates drive motor and LED (unless LED signal is also set, causing the drive LED to blink) (bit mask)
...
NOBUF_MASK = %00000001  ; Reset the sector buffer read/write pointers (bit mask)
...
ALT_MASK = %00000010  ; Selects alternate DPLL read recovery method (not implemented) (bit mask)
...
ALGO_MASK = %00000100  ; Selects reading and writing algorithm (currently ignored). (bit mask)
...
DIR_MASK = %00001000  ; Sets the stepping direction (inward vs (bit mask)
...
STEP_MASK = %00010000  ; Writing 1 causes the head to step in the indicated direction (bit mask)
...
FREE_MASK = %00100000  ; Command is a free-format (low level) operation (bit mask)
...
RDCMD_MASK = %01000000  ; Command is a read operation if set (bit mask)
...
WRCMD_MASK = %10000000  ; Command is a write operation if set (bit mask)
...
TK0_MASK = %00000001  ; F011 Head is over track 0 flag (read only) (bit mask)
...
PROT_MASK = %00000010  ; F011 Disk write protect flag (read only) (bit mask)
...
LOST_MASK = %00000100  ; F011 LOST flag (data was lost during transfer, i.e., CPU did not read data fast enough) (read only) (bit mask)
...
CRC_MASK = %00001000  ; F011 FDC CRC check failure flag (read only) (bit mask)
...
RNF_MASK = %00010000  ; F011 FDC Request Not Found (RNF), i.e., a sector read or write operation did not find the requested sector (read only) (bit mask)
...
EQ_MASK = %00100000  ; F011 FDC CPU and disk pointers to sector buffer are equal, indicating that the sector buffer is either full or empty. (read only) (bit mask)
...
DRQ_MASK = %01000000  ; F011 FDC DRQ flag (one or more bytes of data are ready) (read only) (bit mask)
...
BUSY_MASK = %10000000  ; F011 FDC busy flag (command is being executed) (read only) (bit mask)
...
DSKCHG_MASK = %00000001  ; F011 disk change sense (read only) (bit mask)
...
INDEX_MASK = %00000100  ; F011 Index hole sense (read only) (bit mask)
...
DISKIN_MASK = %00001000  ; F011 Disk sense (read only) (bit mask)
...
WGATE_MASK = %00010000  ; F011 write gate flag. Indicates that the drive is currently writing to media. Bad things may happen if a write transaction is aborted (read only) (bit mask)
...
RUN_MASK = %00100000  ; F011 Successive match. A synonym of RDREQ on the 45IO47 (read only) (bit mask)
...
WTREQ_MASK = %01000000  ; F011 Write Request flag, i.e., the requested sector was found during a write operation (read only) (bit mask)
...
RDREQ_MASK = %10000000  ; F011 Read Request flag, i.e., the requested sector was found during a read operation (read only) (bit mask)
...
RXRDY_MASK = %00000001  ; UART RX byte ready flag (clear by reading \$D600) (bit mask)
...
RXOVRRUN_MASK = %00000010  ; UART RX overrun flag (clear by reading \$D600) (bit mask)
...
PTYERR_MASK = %00000100  ; UART RX parity error flag (clear by reading \$D600) (bit mask)
...
FRMERR_MASK = %00001000  ; UART RX framing error flag (clear by reading \$D600) (bit mask)
...
PTYEVEN_MASK = %00000001  ; UART Parity: 1=even, 0=odd (bit mask)
...
PTYEN_MASK = %00000010  ; UART Parity enable: 1=enabled (bit mask)
...
CHARSZ_MASK = %00001100  ; UART character size: 00=8, 01=7, 10=6, 11=5 bits per byte (bit mask)
...
SYNCMOD_MASK = %00110000  ; UART synchronisation mode flags (00=RX \& TX both async, 01=RX sync, TX async, 1x=TX sync, RX async (unused on the MEGA65) (bit mask)
...
RXEN_MASK = %01000000  ; UART enable receive (bit mask)
...
TXEN_MASK = %10000000  ; UART enable transmit (bit mask)
...
IMRXNMI_MASK = %00010000  ; UART interrupt mask: NMI on RX (not yet implemented on the MEGA65) (bit mask)
...
IMTXNMI_MASK = %00100000  ; UART interrupt mask: NMI on TX (not yet implemented on the MEGA65) (bit mask)
...
IMRXIRQ_MASK = %01000000  ; UART interrupt mask: IRQ on RX (not yet implemented on the MEGA65) (bit mask)
...
IMTXIRQ_MASK = %10000000  ; UART interrupt mask: IRQ on TX (not yet implemented on the MEGA65) (bit mask)
...
IFRXNMI_MASK = %00010000  ; UART interrupt flag: NMI on RX (not yet implemented on the MEGA65) (bit mask)
...
IFTXNMI_MASK = %00100000  ; UART interrupt flag: NMI on TX (not yet implemented on the MEGA65) (bit mask)
...
IFRXIRQ_MASK = %01000000  ; UART interrupt flag: IRQ on RX (not yet implemented on the MEGA65) (bit mask)
...
IFTXIRQ_MASK = %10000000  ; UART interrupt flag: IRQ on TX (not yet implemented on the MEGA65) (bit mask)
...
CAPLOCK_MASK = %00000001  ; C65 capslock key sense (bit mask)
...
KEYCOL8_MASK = %00000010  ; C65 keyboard column 8 select (bit mask)
...
PORTEDDR_MASK = %00000011  ; C65 keyboard extra lines Data Direction Register (DDR) (bit mask)
...
UFAST_MASK = %00000001  ; C65 UART BAUD clock source: 1 = 7.09375MHz, 0 = 80MHz (VIC-IV pixel clock) (bit mask)
...
PORTF_MASK = %00111111  ; PMOD port A on FPGA board (data) (Nexys4 boards only) (bit mask)
...
OSKZON_MASK = %01000000  ; Display hardware zoom of region under first touch point always (bit mask)
...
OSKZEN_MASK = %10000000  ; Display hardware zoom of region under first touch point for on-screen keyboard (bit mask)
...
CONN41_MASK = %00000001  ; Internal 1541 drive connect (1=connect internal 1541 drive to IEC bus) (bit mask)
...
RST41_MASK = %00000010  ; Internal 1541 drive reset (1=reset, 0=operate) (bit mask)
...
SDDATA_MASK = %00000100  ; SD card MOSI/MISO (bit mask)
...
SDCLK_MASK = %00001000  ; SD card SCLK (bit mask)
...
SDCS_MASK = %00010000  ; SD card CS_BO (bit mask)
...
SDBSH_MASK = %00100000  ; Enable SD card bitbash mode (bit mask)
...
HDSDA_MASK = %01000000  ; HDMI I2C control interface SDA data line (bit mask)
...
HDSCL_MASK = %10000000  ; HDMI I2C control interface SCL clock (bit mask)
...
KEYLEFT_MASK = %00000001  ; Directly read C65 Cursor left key (bit mask)
...
KEYUP_MASK = %00000010  ; Directly read C65 Cursor up key (bit mask)
...
REALHW_MASK = %00100000  ; Set to 1 if the MEGA65 is running on real hardware, set to 0 if emulated (Xemu) or simulated (ghdl) (bit mask)
...
OSKDIM_MASK = %01000000  ; Light or heavy dimming of background material behind on-screen keyboard (bit mask)
...
ACCESSKEY_MASK = %10000000  ; Enable accessible keyboard input via joystick port 2 fire button (bit mask)
...
MRSHFT_MASK = %00000001  ; Right shift key state (hardware accelerated keyboard scanner). (bit mask)
...
MLSHFT_MASK = %00000010  ; Left shift key state (hardware accelerated keyboard scanner). (bit mask)
...
MCTRL_MASK = %00000100  ; CTRL key state (hardware accelerated keyboard scanner). (bit mask)
...
MMEGA_MASK = %00001000  ; MEGA/C= key state (hardware accelerated keyboard scanner). (bit mask)
...
MALT_MASK = %00010000  ; ALT key state (hardware accelerated keyboard scanner). (bit mask)
...
MSCRL_MASK = %00100000  ; NOSCRL key state (hardware accelerated keyboard scanner). (bit mask)
...
MCAPS_MASK = %01000000  ; CAPS LOCK key state (hardware accelerated keyboard scanner). (bit mask)
...
WGTKEY_MASK = %00000001  ; Enable widget board keyboard/joystick input (bit mask)
...
PS2KEY_MASK = %00000010  ; Enable ps2 keyboard/joystick input (bit mask)
...
PHYKEY_MASK = %00000100  ; Enable physical keyboard input (bit mask)
...
VRTKEY_MASK = %00001000  ; Enable virtual/snythetic keyboard input (bit mask)
...
OSKDEBUG_MASK = %00010000  ; Debug OSK overlay (WRITE ONLY) (bit mask)
...
PS2JOY_MASK = %00010000  ; Enable PS/2 / USB keyboard simulated joystick input (bit mask)
...
JOYSWAP_MASK = %00100000  ; Exchange joystick ports 1 \& 2 (bit mask)
...
LJOYA_MASK = %01000000  ; Rotate inputs of joystick A by 180 degrees (for left handed use) (bit mask)
...
LJOYB_MASK = %10000000  ; Rotate inputs of joystick B by 180 degrees (for left handed use) (bit mask)
...
VIRTKEY1_MASK = %01111111  ; Set to \$7F for no key down, else specify virtual key press. (bit mask)
...
OSKEN_MASK = %10000000  ; Enable display of on-screen keyboard composited overlay (bit mask)
...
VIRTKEY2_MASK = %01111111  ; Set to \$7F for no key down, else specify 2nd virtual key press. (bit mask)
...
OSKALT_MASK = %10000000  ; Display alternate on-screen keyboard layout (typically dial pad for MEGA65 telephone) (bit mask)
...
VIRTKEY3_MASK = %01111111  ; Set to \$7F for no key down, else specify 3nd virtual key press. (bit mask)
...
OSKTOP_MASK = %10000000  ; 1=Display on-screen keyboard at top, 0=Disply on-screen keyboard at bottom of screen. (bit mask)
...
AUDMUTE_MASK = %00000001  ; Mute digital video audio (MEGA65 R2 only) (bit mask)
...
DVI_MASK = %00000010  ; Control digital video as DVI (disables audio) (bit mask)
...
AUDDBG_MASK = %00000100  ; Visualise audio samples (DEBUG) (bit mask)
...
AUD48K_MASK = %00001000  ; Select 48KHz or 44.1KHz digital video audio sample rate (bit mask)
...
AUDINV_MASK = %10000000  ; Invert digital video audio sample values (bit mask)
...
SIDMODE_MASK = %00001111  ; Select SID mode: 0=6581, 1=8580 (bit mask)
...
DCTRKEN_MASK = %00010000  ; Enable DC offset subtraction in audio mixer (bit mask)
...
RESETSRC_MASK = %11100000  ; Source of last CPU reset (bit mask)
...
VICMODE_MASK = %00000011  ; VIC-II/VIC-III/VIC-IV mode select (bit mask)
...
EXSID_MASK = %00000100  ; 0=Use internal SIDs, 1=Use external(1) SIDs (bit mask)
...
MATRIXEN_MASK = %01000000  ; Enable composited Matrix Mode, and disable UART access to serial monitor. (bit mask)
...
UARTDATA_MASK = %11111111  ; (write) Hypervisor write serial output to UART monitor (bit mask)
...
RSVD_MASK = %00000001  ; RESERVED (bit mask)
...
JMP32EN_MASK = %00000010  ; Hypervisor enable 32-bit JMP/JSR etc (bit mask)
...
ROMPROT_MASK = %00000100  ; Hypervisor write protect C65 ROM \$20000-\$3FFFF (bit mask)
...
ASCFAST_MASK = %00001000  ; Hypervisor enable ASC/DIN CAPS LOCK key to enable/disable CPU slow-down in C64/C128/C65 modes (bit mask)
...
CPUFAST_MASK = %00010000  ; Hypervisor force CPU to 48MHz for userland (userland can override via POKE0) (bit mask)
...
F4502_MASK = %00100000  ; Hypervisor force CPU to 4502 personality, even in C64 IO mode. (bit mask)
...
PIRQ_MASK = %01000000  ; Hypervisor flag to indicate if an IRQ is pending on exit from the hypervisor / set 1 to force IRQ/NMI deferal for 1,024 cycles on exit from hypervisor. (bit mask)
...
PNMI_MASK = %10000000  ; Hypervisor flag to indicate if an NMI is pending on exit from the hypervisor. (bit mask)
...
BUFBIT8_MASK = %00000001  ; (read only) reads bit 8 of the sector buffer pointer (bit mask)
...
BUFFFULL_MASK = %00000010  ; (read only) if set, indicates that the sector buffer is full and has not yet been read (bit mask)
...
HNDSHK_MASK = %00000100  ; Set/read SD card sd_handshake signal (bit mask)
...
DRDY_MASK = %00001000  ; SD Card Data Ready indication (bit mask)
...
FDCSWAP_MASK = %00100000  ; Set to swap floppy drive 0 (the internal drive) and drive 1 (the drive on the 2nd position on the internal floppy cable). (bit mask)
...
BUFFSEL_MASK = %10000000  ; Set to switch sector buffer to view SD card direct access, clear for access to the F011 FDC sector buffer. (bit mask)
...
CDC00_MASK = %00000001  ; (read only) Set if colour RAM at $DC00 (bit mask)
...
VICIII_MASK = %00000010  ; (read only) Set if VIC-IV or ethernet IO bank visible (bit mask)
...
VFDC0_MASK = %00000100  ; (read only) Set if drive 0 is virtualised (sectors delivered via serial monitor interface) (bit mask)
...
VFDC1_MASK = %00001000  ; (read only) Set if drive 1 is virtualised (sectors delivered via serial monitor interface) (bit mask)
...
D0IMG_MASK = %00000001  ; F011 drive 0 use disk image if set, otherwise use real floppy drive. (bit mask)
...
D0P_MASK = %00000010  ; F011 drive 0 media present (bit mask)
...
D0WP_MASK = %00000100  ; Write enable F011 drive 0 (bit mask)
...
D1IMG_MASK = %00001000  ; F011 drive 1 use disk image if set, otherwise use real floppy drive. (bit mask)
...
D1P_MASK = %00010000  ; F011 drive 1 media present (bit mask)
...
D1WP_MASK = %00100000  ; Write enable F011 drive 1 (bit mask)
...
D0MD_MASK = %01000000  ; F011 drive 0 disk image is 64MiB mega image if set (otherwise 800KiB 1581 image) (bit mask)
...
D1MD_MASK = %10000000  ; F011 drive 1 disk image is 64MiB mega image if set (otherwise 800KiB 1581 image) (bit mask)
...
DBGWDATA_MASK = %00000100  ; Control floppy drive WDATA line (bit mask)
...
DENSITY_MASK = %10000000  ; Control floppy drive density select line (bit mask)
...
DRV0EN_MASK = %00000001  ; Use real floppy drive instead of SD card for 1st floppy drive (bit mask)
...
USEREAL0_MASK = %00000001  ; Use real floppy drive for drive 0 if set (read-only, except for from hypervisor) (bit mask)
...
TARGANY_MASK = %00000010  ; Read next sector under head if set, ignoring the requested side, track and sector number. (bit mask)
...
DRV2EN_MASK = %00000100  ; Use real floppy drive instead of SD card for 2nd floppy drive (bit mask)
...
USEREAL1_MASK = %00000100  ; Use real floppy drive for drive 1 if set (read-only, except for from hypervisor) (bit mask)
...
SILENT_MASK = %00001000  ; Disable floppy spinning and tracking for SD card operations. (bit mask)
...
WHEEL3TARGET_MASK = %00001111  ; Select audio channel volume to be set by thumb wheel #3 (bit mask)
...
WHEELBRIGHTEN_MASK = %10000000  ; Enable control of LCD panel brightness via thumb wheel (bit mask)
...
WHEEL1TARGET_MASK = %00001111  ; Select audio channel volume to be set by thumb wheel #1 (bit mask)
...
WHEEL2TARGET_MASK = %11110000  ; Select audio channel volume to be set by thumb wheel #2 (bit mask)
...
FDC_ENC_MASK = %00001111  ; Select floppy encoding (0=MFM, 1=RLL2,7, F=Raw encoding) (bit mask)
...
AUTO_2XSEL_MASK = %00010000  ; Automatically select DD or HD decoder for last sector display (bit mask)
...
FDC_VARSPD_MASK = %00100000  ; Enable automatic variable speed selection for floppy controller using Track Information Blocks on MEGA65 HD floppies (bit mask)
...
FDC_2XSEL_MASK = %01000000  ; Select HD decoder for last sector display (bit mask)
...
FDC_TIBEN_MASK = %10000000  ; Enable use of Track Info Block settings (bit mask)
...
VR_FOUND_MASK = %00000001  ; Manually set f011_rsector_found signal (indented for virtual F011 mode only) (bit mask)
...
VW_FOUND_MASK = %00000010  ; Manually set f011_wsector_found signal (indented for virtual F011 mode only) (bit mask)
...
VEQ_INH_MASK = %00000100  ; Manually set f011_eq_inhibit signal (indented for virtual F011 mode only) (bit mask)
...
VRNF_MASK = %00001000  ; Manually set f011_rnf signal (indented for virtual F011 mode only) (bit mask)
...
VDRQ_MASK = %00010000  ; Manually set f011_drq signal (indented for virtual F011 mode only) (bit mask)
...
VLOST_MASK = %00100000  ; Manually set f011_lost signal (indented for virtual F011 mode only) (bit mask)
...
EV1_MASK = %00000001  ; Touch event 1 is valid (bit mask)
...
EV2_MASK = %00000010  ; Touch event 2 is valid (bit mask)
...
UPDN1_MASK = %00001100  ; Touch event 1 up/down state (bit mask)
...
UPDN2_MASK = %00110000  ; Touch event 2 up/down state (bit mask)
...
XINV_MASK = %01000000  ; Invert horizontal axis (bit mask)
...
YINV_MASK = %10000000  ; Invert vertical axis (bit mask)
...
TOUCH1XMSB_MASK = %00000011  ; Touch pad touch \#1 X MSBs (bit mask)
...
TOUCH1YMSB_MASK = %00110000  ; Touch pad touch \#1 Y MSBs (bit mask)
...
TOUCH2XMSB_MASK = %00000011  ; Touch pad touch \#2 X MSBs (bit mask)
...
TOUCH2YMSB_MASK = %00110000  ; Touch pad touch \#2 Y MSBs (bit mask)
...
TCHBYTENUM_MASK = %01111111  ; Select byte number for touch panel communications instrumentation (bit mask)
...
TCHI2CEN_MASK = %10000000  ; Enable/disable touch panel I2C communications (bit mask)
...
GESTUREDIR_MASK = %00001111  ; Touch pad gesture directions (left,right,up,down) (bit mask)
...
GESTUREID_MASK = %11110000  ; Touch pad gesture ID (bit mask)
...
DB_MASK = %00001111  ; Data bits for QSPI flash interface (read/write) (bit mask)
...
CSN_MASK = %01000000  ; Active-low chip-select for QSPI flash (bit mask)
...
TRI_MASK = %10000000  ; Tristate DB0-3 (bit mask)
...
CLOCKRUN_MASK = %00000001  ; Set to cause QSPI clock to free run at CPU clock frequency. (bit mask)
...
I2CRST_MASK = %00000001  ; I2C reset (bit mask)
...
I2CL_MASK = %00000010  ; I2C command latch write strobe (write 1 to trigger command) (bit mask)
...
I2CRW_MASK = %00000100  ; I2C Select read (1) or write (0) (bit mask)
...
I2CSW_MASK = %00100000  ; I2C bus 1 swap SDA/SCL pins (bit mask)
...
I2CBSY_MASK = %01000000  ; I2C busy flag (bit mask)
...
I2CERR_MASK = %10000000  ; I2C ack error (bit mask)
...
I2CADDR_MASK = %11111110  ; I2C address (bit mask)
...
TXRST_MASK = %00000010  ; Write 0 to hold ethernet controller transmit sub-system under reset (bit mask)
...
DRXD_MASK = %00000100  ; Read ethernet RX bits currently on the wire (bit mask)
...
DRXDV_MASK = %00001000  ; Read ethernet RX data valid (debug) (bit mask)
...
KEYEN_MASK = %00010000  ; Allow remote keyboard input via magic ethernet frames (bit mask)
...
RXBLKD_MASK = %01000000  ; Indicate if ethernet RX is blocked until RX buffers freed (bit mask)
...
TXIDLE_MASK = %10000000  ; Ethernet transmit side is idle, i.e., a packet can be sent. (bit mask)
...
RXBF_MASK = %00000110  ; Number of free receive buffers (bit mask)
...
STRM_MASK = %00001000  ; Enable streaming of CPU instruction stream or VIC-IV display on ethernet (bit mask)
...
TXQ_MASK = %00010000  ; Ethernet TX IRQ status (bit mask)
...
RXQ_MASK = %00100000  ; Ethernet RX IRQ status (bit mask)
...
TXQEN_MASK = %01000000  ; Enable ethernet TX IRQ (bit mask)
...
RXQEN_MASK = %10000000  ; Enable ethernet RX IRQ (bit mask)
...
NOPROM_MASK = %00000001  ; Ethernet disable promiscuous mode (bit mask)
...
NOCRC_MASK = %00000010  ; Disable CRC check for received packets (bit mask)
...
TXPH_MASK = %00001100  ; Ethernet TX clock phase adjust (bit mask)
...
BCST_MASK = %00010000  ; Accept broadcast frames (bit mask)
...
MCST_MASK = %00100000  ; Accept multicast frames (bit mask)
...
RXPH_MASK = %11000000  ; Ethernet RX clock phase adjust (bit mask)
...
MIIMREG_MASK = %00011111  ; Ethernet MIIM register number (bit mask)
...
MIIMPHY_MASK = %11100000  ; Ethernet MIIM PHY number (use 0 for Nexys4, 1 for MEGA65 r1 PCBs) (bit mask)
...
EN018B_MASK = %00000001  ; DMA enable F018B mode (adds sub-command byte) (bit mask)
...
MULBUSY_MASK = %01000000  ; Set if hardware multiplier is busy (bit mask)
...
DIVBUSY_MASK = %10000000  ; Set if hardware divider is busy (bit mask)
...
BADLEN_MASK = %00000001  ; Enable badline emulation (bit mask)
...
SLIEN_MASK = %00000010  ; Enable 6502-style slow (7 cycle) interrupts (bit mask)
...
VDCSEN_MASK = %00000100  ; Enable VDC inteface simulation (bit mask)
...
BRCOST_MASK = %00001000  ; 1=charge extra cycle(s) for branches taken (bit mask)
...
BADEXTRA_MASK = %00110000  ; Cost of badlines minus 40. ie. 00=40 cycles, 11 = 43 cycles. (bit mask)
...
AUD_BLKTO_MASK = %00000111  ; Audio DMA block timeout (read only) DEBUG (bit mask)
...
PWMPDM_MASK = %00001000  ; PWM/PDM audio encoding select (bit mask)
...
NOMIX_MASK = %00010000  ; Audio DMA bypasses audio mixer (bit mask)
...
AUD_WRBLK_MASK = %00100000  ; Audio DMA block writes (samples still get read) (bit mask)
...
BLKD_MASK = %01000000  ; Audio DMA blocked (read only) DEBUG (bit mask)
...
AUDEN_MASK = %10000000  ; Enable Audio DMA (bit mask)
...
CH0_SBITS_MASK = %00000011  ; Audio DMA channel X sample bits (11=16, 10=8, 01=upper nybl, 00=lower nybl) (bit mask)
...
CH0_STP_MASK = %00001000  ; Audio DMA channel X stop flag (bit mask)
...
CH0_SINE_MASK = %00010000  ; Audio DMA channel X play 32-sample sine wave instead of DMA data (bit mask)
...
CH0_SGN_MASK = %00100000  ; Enable Audio DMA channel X signed samples (bit mask)
...
CH0_LOOP_MASK = %01000000  ; Enable Audio DMA channel X looping (bit mask)
...
CH0_EN_MASK = %10000000  ; Enable Audio DMA channel X (bit mask)
...
UNIT0INA_MASK = %00001111  ; Select which of the 16 32-bit math registers is input A for Math Function Unit X. (bit mask)
...
UNIT0OUT_MASK = %00001111  ; Select which of the 16 32-bit math registers receives the output of Math Function Unit X (bit mask)
...
U0_LOWOUT_MASK = %00010000  ; If set, the low-half of the output of Math Function Unit X is written to math register UNITXOUT. (bit mask)
...
U0_HIOUT_MASK = %00100000  ; If set, the high-half of the output of Math Function Unit X is written to math register UNITXOUT. (bit mask)
...
U0_MLADD_MASK = %01000000  ; If set, Math Function Unit X acts as a 32-bit adder instead of 32-bit multiplier. (bit mask)
...
WREN_MASK = %00000001  ; Enable setting of math registers (must normally be set) (bit mask)
...
CALCEN_MASK = %00000010  ; Enable committing of output values from math units back to math registers (clearing effectively pauses iterative formulae) (bit mask)
...
IECBUSACT_MASK = %00000001  ; IEC bus is active (bit mask)
...
CARTEN_MASK = %00000010  ; 1= enable cartridges (bit mask)
...
POWEREN_MASK = %00000001  ; Set to zero to power off computer on supported systems. WRITE ONLY. (bit mask)
...
NOGAME_MASK = %01000000  ; Override for /GAME : Must be 0 to enable /GAME signal (bit mask)
...
NOEXROM_MASK = %10000000  ; Override for /EXROM : Must be 0 to enable /EXROM signal (bit mask)
...
PREFETCH_MASK = %00000001  ; Enable expansion RAM pre-fetch logic (bit mask)
...
OCEANA_MASK = %00000010  ; Enable Ocean Type A cartridge emulation (bit mask)
...
TODMIN_MASK = %00111111  ; TOD minutes (bit mask)
...
IR_MASK = %10000000  ; Interrupt flag (bit mask)
...
DD00DELAY_MASK = %10000000  ; Enable delaying writes to $DD00 by 3 cycles to match real 6502 timing (bit mask)
