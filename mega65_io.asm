...
.var VIC2_YSCL_MASK = 7  // 24/25 vertical smooth scroll (bit mask)
.var YSCL_MASK = 7  // 24/25 vertical smooth scroll (bit mask)
.var VIC2_RSEL_ADDR = $D011  // 24/25 row select (address)
.var RSEL_ADDR = $D011  // 24/25 row select (address)
.var VIC2_RSEL_MASK = 8  // 24/25 row select (bit mask)
.var RSEL_MASK = 8  // 24/25 row select (bit mask)
.var VIC2_BLNK_ADDR = $D011  // disable display (address)
.var BLNK_ADDR = $D011  // disable display (address)
.var VIC2_BLNK_MASK = 16  // disable display (bit mask)
.var BLNK_MASK = 16  // disable display (bit mask)
.var VIC2_BMM_ADDR = $D011  // bitmap mode (address)
.var BMM_ADDR = $D011  // bitmap mode (address)
.var VIC2_BMM_MASK = 32  // bitmap mode (bit mask)
.var BMM_MASK = 32  // bitmap mode (bit mask)
.var VIC2_ECM_ADDR = $D011  // extended background mode (address)
.var ECM_ADDR = $D011  // extended background mode (address)
.var VIC2_ECM_MASK = 64  // extended background mode (bit mask)
.var ECM_MASK = 64  // extended background mode (bit mask)
.var VIC2_RC_ADDR = $D011  // raster compare bit 8 (address)
.var RC_ADDR = $D011  // raster compare bit 8 (address)
.var VIC2_RC_MASK = 128  // raster compare bit 8 (bit mask)
.var RC_MASK = 128  // raster compare bit 8 (bit mask)
...
.var VIC2_XSCL_MASK = 7  // horizontal smooth scroll (bit mask)
.var XSCL_MASK = 7  // horizontal smooth scroll (bit mask)
.var VIC2_CSEL_ADDR = $D016  // 38/40 column select (address)
.var CSEL_ADDR = $D016  // 38/40 column select (address)
.var VIC2_CSEL_MASK = 8  // 38/40 column select (bit mask)
.var CSEL_MASK = 8  // 38/40 column select (bit mask)
.var VIC2_MCM_ADDR = $D016  // Multi-colour mode (address)
.var MCM_ADDR = $D016  // Multi-colour mode (address)
.var VIC2_MCM_MASK = 16  // Multi-colour mode (bit mask)
.var MCM_MASK = 16  // Multi-colour mode (bit mask)
.var VIC2_RST_ADDR = $D016  // Disables video output on MAX Machine(tm) VIC-II 6566. Ignored on normal C64s and the MEGA65 (address)
.var VIC2_RST_MASK = 32  // Disables video output on MAX Machine(tm) VIC-II 6566. Ignored on normal C64s and the MEGA65 (bit mask)
...
.var VIC2_CB_MASK = 14  // character set address location ($\times$ 1KiB) (bit mask)
.var CB_MASK = 14  // character set address location ($\times$ 1KiB) (bit mask)
.var VIC2_VS_ADDR = $D018  // screen address ($\times$ 1KiB) (address)
.var VS_ADDR = $D018  // screen address ($\times$ 1KiB) (address)
.var VIC2_VS_MASK = 240  // screen address ($\times$ 1KiB) (bit mask)
.var VS_MASK = 240  // screen address ($\times$ 1KiB) (bit mask)
...
.var VIC2_RIRQ_MASK = 1  // raster compare indicate or acknowledge (bit mask)
.var RIRQ_MASK = 1  // raster compare indicate or acknowledge (bit mask)
...
.var VIC2_ISBC_MASK = 2  // sprite:bitmap collision indicate or acknowledge (bit mask)
.var ISBC_MASK = 2  // sprite:bitmap collision indicate or acknowledge (bit mask)
...
.var VIC2_ISSC_MASK = 4  // sprite:sprite collision indicate or acknowledge (bit mask)
.var ISSC_MASK = 4  // sprite:sprite collision indicate or acknowledge (bit mask)
...
.var VIC2_ILP_MASK = 8  // light pen indicate or acknowledge (bit mask)
.var ILP_MASK = 8  // light pen indicate or acknowledge (bit mask)
.var VIC2_MRIRQ_ADDR = $D01A  // mask raster IRQ (address)
.var MRIRQ_ADDR = $D01A  // mask raster IRQ (address)
.var VIC2_MRIRQ_MASK = 1  // mask raster IRQ (bit mask)
.var MRIRQ_MASK = 1  // mask raster IRQ (bit mask)
...
.var VIC2_MISBC_MASK = 2  // mask sprite:bitmap collision IRQ (bit mask)
.var MISBC_MASK = 2  // mask sprite:bitmap collision IRQ (bit mask)
...
.var VIC2_MISSC_MASK = 4  // mask sprite:sprite collision IRQ (bit mask)
.var MISSC_MASK = 4  // mask sprite:sprite collision IRQ (bit mask)
...
.var VIC2_BORDERCOL_MASK = 15  // display border colour (16 colour) (bit mask)
.var VIC3_BORDERCOL_ADDR = $D020  // display border colour (256 colour) (address)
.var VIC3_BORDERCOL_MASK = 255  // display border colour (256 colour) (bit mask)
.var VIC4_BORDERCOL_ADDR = $D020  // display border colour (256 colour) (address)
.var VIC4_BORDERCOL_MASK = 255  // display border colour (256 colour) (bit mask)
.var VIC2_SCREENCOL_ADDR = $D021  // screen colour (16 colour) (address)
.var VIC2_SCREENCOL_MASK = 15  // screen colour (16 colour) (bit mask)
.var VIC3_SCREENCOL_ADDR = $D021  // screen colour (256 colour) (address)
.var VIC3_SCREENCOL_MASK = 255  // screen colour (256 colour) (bit mask)
.var VIC4_SCREENCOL_ADDR = $D021  // screen colour (256 colour) (address)
.var VIC4_SCREENCOL_MASK = 255  // screen colour (256 colour) (bit mask)
.var VIC2_MC1_ADDR = $D022  // multi-colour 1 (16 colour) (address)
.var VIC2_MC1_MASK = 15  // multi-colour 1 (16 colour) (bit mask)
.var VIC3_MC1_ADDR = $D022  // multi-colour 1 (256 colour) (address)
.var VIC3_MC1_MASK = 255  // multi-colour 1 (256 colour) (bit mask)
.var VIC4_MC1_ADDR = $D022  // multi-colour 1 (256 colour) (address)
.var VIC4_MC1_MASK = 255  // multi-colour 1 (256 colour) (bit mask)
.var VIC2_MC2_ADDR = $D023  // multi-colour 2 (16 colour) (address)
.var VIC2_MC2_MASK = 15  // multi-colour 2 (16 colour) (bit mask)
.var VIC3_MC2_ADDR = $D023  // multi-colour 2 (256 colour) (address)
.var VIC3_MC2_MASK = 255  // multi-colour 2 (256 colour) (bit mask)
.var VIC4_MC2_ADDR = $D023  // multi-colour 2 (256 colour) (address)
.var VIC4_MC2_MASK = 255  // multi-colour 2 (256 colour) (bit mask)
.var VIC2_MC3_ADDR = $D024  // multi-colour 3 (16 colour) (address)
.var VIC2_MC3_MASK = 15  // multi-colour 3 (16 colour) (bit mask)
.var VIC3_MC3_ADDR = $D024  // multi-colour 3 (256 colour) (address)
.var VIC3_MC3_MASK = 255  // multi-colour 3 (256 colour) (bit mask)
.var VIC4_MC3_ADDR = $D024  // multi-colour 3 (256 colour) (address)
.var VIC4_MC3_MASK = 255  // multi-colour 3 (256 colour) (bit mask)
...
.var VIC2_C128_FAST_MASK = 1  // 2MHz select (for C128 2MHz emulation) (bit mask)
.var C128_FAST_MASK = 1  // 2MHz select (for C128 2MHz emulation) (bit mask)
...
.var VIC3_CRAM2K_MASK = 1  // Map 2nd KB of colour RAM @ $DC00-$DFFF (bit mask)
.var CRAM2K_MASK = 1  // Map 2nd KB of colour RAM @ $DC00-$DFFF (bit mask)
...
.var VIC3_EXTSYNC_MASK = 2  // Enable external video sync (genlock input) (bit mask)
.var EXTSYNC_MASK = 2  // Enable external video sync (genlock input) (bit mask)
...
.var VIC3_PAL_MASK = 4  // Use PALETTE ROM (0) or RAM (1) entries for colours 0 - 15 (bit mask)
.var PAL_MASK = 4  // Use PALETTE ROM (0) or RAM (1) entries for colours 0 - 15 (bit mask)
.var VIC3_ROM8_ADDR = $D030  // Map C65 ROM @ $8000 (address)
.var ROM8_ADDR = $D030  // Map C65 ROM @ $8000 (address)
.var VIC3_ROM8_MASK = 8  // Map C65 ROM @ $8000 (bit mask)
.var ROM8_MASK = 8  // Map C65 ROM @ $8000 (bit mask)
.var VIC3_ROMA_ADDR = $D030  // Map C65 ROM @ $A000 (address)
.var ROMA_ADDR = $D030  // Map C65 ROM @ $A000 (address)
.var VIC3_ROMA_MASK = 16  // Map C65 ROM @ $A000 (bit mask)
.var ROMA_MASK = 16  // Map C65 ROM @ $A000 (bit mask)
.var VIC3_ROMC_ADDR = $D030  // Map C65 ROM @ $C000 (address)
.var ROMC_ADDR = $D030  // Map C65 ROM @ $C000 (address)
.var VIC3_ROMC_MASK = 32  // Map C65 ROM @ $C000 (bit mask)
.var ROMC_MASK = 32  // Map C65 ROM @ $C000 (bit mask)
...
.var VIC3_CROM9_MASK = 64  // Select between C64 and C65 charset. (bit mask)
.var CROM9_MASK = 64  // Select between C64 and C65 charset. (bit mask)
.var VIC3_ROME_ADDR = $D030  // Map C65 ROM @ $E000 (address)
.var ROME_ADDR = $D030  // Map C65 ROM @ $E000 (address)
.var VIC3_ROME_MASK = 128  // Map C65 ROM @ $E000 (bit mask)
.var ROME_MASK = 128  // Map C65 ROM @ $E000 (bit mask)
...
.var VIC3_INT_MASK = 1  // Enable VIC-III interlaced mode (bit mask)
.var INT_MASK = 1  // Enable VIC-III interlaced mode (bit mask)
...
.var VIC3_MONO_MASK = 2  // Enable VIC-III MONO video output (not implemented) (bit mask)
.var MONO_MASK = 2  // Enable VIC-III MONO video output (not implemented) (bit mask)
...
.var VIC3_H1280_MASK = 4  // Enable 1280 horizontal pixels (not implemented) (bit mask)
.var H1280_MASK = 4  // Enable 1280 horizontal pixels (not implemented) (bit mask)
.var VIC3_V400_ADDR = $D031  // Enable 400 vertical pixels (address)
.var V400_ADDR = $D031  // Enable 400 vertical pixels (address)
.var VIC3_V400_MASK = 8  // Enable 400 vertical pixels (bit mask)
.var V400_MASK = 8  // Enable 400 vertical pixels (bit mask)
.var VIC3_BPM_ADDR = $D031  // Bit-Plane Mode (address)
.var BPM_ADDR = $D031  // Bit-Plane Mode (address)
.var VIC3_BPM_MASK = 16  // Bit-Plane Mode (bit mask)
.var BPM_MASK = 16  // Bit-Plane Mode (bit mask)
...
.var VIC3_ATTR_MASK = 32  // Enable extended attributes and 8 bit colour entries (bit mask)
.var ATTR_MASK = 32  // Enable extended attributes and 8 bit colour entries (bit mask)
.var VIC3_FAST_ADDR = $D031  // Enable C65 FAST mode (~3.5MHz) (address)
.var FAST_ADDR = $D031  // Enable C65 FAST mode (~3.5MHz) (address)
.var VIC3_FAST_MASK = 64  // Enable C65 FAST mode (~3.5MHz) (bit mask)
.var FAST_MASK = 64  // Enable C65 FAST mode (~3.5MHz) (bit mask)
...
.var VIC3_H640_MASK = 128  // Enable C64 640 horizontal pixels / 80 column mode (bit mask)
.var H640_MASK = 128  // Enable C64 640 horizontal pixels / 80 column mode (bit mask)
...
.var VIC3_B0ADEVN_MASK = 14  // Bitplane X address, even lines (bit mask)
.var B0ADEVN_MASK = 14  // Bitplane X address, even lines (bit mask)
...
.var VIC3_B0ADODD_MASK = 224  // Bitplane X address, odd lines (bit mask)
.var B0ADODD_MASK = 224  // Bitplane X address, odd lines (bit mask)
.var VIC3_B1ADEVN_ADDR = $D034  // @BXADEVN (address)
.var B1ADEVN_ADDR = $D034  // @BXADEVN (address)
.var VIC3_B1ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var B1ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var VIC3_B1ADODD_ADDR = $D034  // @BXADODD (address)
.var B1ADODD_ADDR = $D034  // @BXADODD (address)
.var VIC3_B1ADODD_MASK = 224  // @BXADODD (bit mask)
.var B1ADODD_MASK = 224  // @BXADODD (bit mask)
.var VIC3_B2ADEVN_ADDR = $D035  // @BXADEVN (address)
.var B2ADEVN_ADDR = $D035  // @BXADEVN (address)
.var VIC3_B2ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var B2ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var VIC3_B2ADODD_ADDR = $D035  // @BXADODD (address)
.var B2ADODD_ADDR = $D035  // @BXADODD (address)
.var VIC3_B2ADODD_MASK = 224  // @BXADODD (bit mask)
.var B2ADODD_MASK = 224  // @BXADODD (bit mask)
.var VIC3_B3ADEVN_ADDR = $D036  // @BXADEVN (address)
.var B3ADEVN_ADDR = $D036  // @BXADEVN (address)
.var VIC3_B3ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var B3ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var VIC3_B3ADODD_ADDR = $D036  // @BXADODD (address)
.var B3ADODD_ADDR = $D036  // @BXADODD (address)
.var VIC3_B3ADODD_MASK = 224  // @BXADODD (bit mask)
.var B3ADODD_MASK = 224  // @BXADODD (bit mask)
.var VIC3_B4ADEVN_ADDR = $D037  // @BXADEVN (address)
.var B4ADEVN_ADDR = $D037  // @BXADEVN (address)
.var VIC3_B4ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var B4ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var VIC3_B4ADODD_ADDR = $D037  // @BXADODD (address)
.var B4ADODD_ADDR = $D037  // @BXADODD (address)
.var VIC3_B4ADODD_MASK = 224  // @BXADODD (bit mask)
.var B4ADODD_MASK = 224  // @BXADODD (bit mask)
.var VIC3_B5ADEVN_ADDR = $D038  // @BXADEVN (address)
.var B5ADEVN_ADDR = $D038  // @BXADEVN (address)
.var VIC3_B5ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var B5ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var VIC3_B5ADODD_ADDR = $D038  // @BXADODD (address)
.var B5ADODD_ADDR = $D038  // @BXADODD (address)
.var VIC3_B5ADODD_MASK = 224  // @BXADODD (bit mask)
.var B5ADODD_MASK = 224  // @BXADODD (bit mask)
.var VIC3_B6ADEVN_ADDR = $D039  // @BXADEVN (address)
.var B6ADEVN_ADDR = $D039  // @BXADEVN (address)
.var VIC3_B6ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var B6ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var VIC3_B6ADODD_ADDR = $D039  // @BXADODD (address)
.var B6ADODD_ADDR = $D039  // @BXADODD (address)
.var VIC3_B6ADODD_MASK = 224  // @BXADODD (bit mask)
.var B6ADODD_MASK = 224  // @BXADODD (bit mask)
.var VIC3_B7ADEVN_ADDR = $D03A  // @BXADEVN (address)
.var B7ADEVN_ADDR = $D03A  // @BXADEVN (address)
.var VIC3_B7ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var B7ADEVN_MASK = 14  // @BXADEVN (bit mask)
.var VIC3_B7ADODD_ADDR = $D03A  // @BXADODD (address)
.var B7ADODD_ADDR = $D03A  // @BXADODD (address)
.var VIC3_B7ADODD_MASK = 224  // @BXADODD (bit mask)
.var B7ADODD_MASK = 224  // @BXADODD (bit mask)
...
.var VIC4_TBDRPOS_MASK = 15  // top border position MSB (bit mask)
.var TBDRPOS_MASK = 15  // top border position MSB (bit mask)
.var VIC4_SPRBPMEN_ADDR = $D049  // Sprite bitplane-modify-mode enables (address)
.var VIC4_SPRBPMEN_MASK = 240  // Sprite bitplane-modify-mode enables (bit mask)
...
.var VIC4_BBDRPOS_MASK = 15  // bottom border position (bit mask)
.var BBDRPOS_MASK = 15  // bottom border position (bit mask)
.var GS_VIC4_SPRBPMEN_ADDR = $D04B  // Sprite bitplane-modify-mode enables (address)
.var GS_VIC4_SPRBPMEN_MASK = 240  // Sprite bitplane-modify-mode enables (bit mask)
...
.var VIC4_TEXTXPOS_MASK = 15  // character generator horizontal position (bit mask)
.var TEXTXPOS_MASK = 15  // character generator horizontal position (bit mask)
.var VIC4_SPRTILEN_ADDR = $D04D  // Sprite horizontal tile enables. (address)
.var VIC4_SPRTILEN_MASK = 240  // Sprite horizontal tile enables. (bit mask)
...
.var VIC4_TEXTYPOS_MASK = 15  // Character generator vertical position (bit mask)
.var TEXTYPOS_MASK = 15  // Character generator vertical position (bit mask)
.var GS_VIC4_SPRTILEN_ADDR = $D04F  // Sprite 7-4 horizontal tile enables (address)
.var GS_VIC4_SPRTILEN_MASK = 240  // Sprite 7-4 horizontal tile enables (bit mask)
...
.var VIC4_XPOSMSB_MASK = 63  // Read horizontal raster scan position MSB (bit mask)
.var XPOSMSB_MASK = 63  // Read horizontal raster scan position MSB (bit mask)
...
.var VIC4_DBLRR_MASK = 64  // When set, the Raster Rewrite Buffer is only updated every 2nd raster line, limiting resolution to V200, but allowing more cycles for Raster-Rewrite actions. (bit mask)
.var DBLRR_MASK = 64  // When set, the Raster Rewrite Buffer is only updated every 2nd raster line, limiting resolution to V200, but allowing more cycles for Raster-Rewrite actions. (bit mask)
...
.var VIC4_NORRDEL_MASK = 128  // When clear, raster rewrite double buffering is used (bit mask)
.var NORRDEL_MASK = 128  // When clear, raster rewrite double buffering is used (bit mask)
...
.var VIC4_FN_RASTER_MSB_MASK = 7  // Read physical raster position (bit mask)
.var FN_RASTER_MSB_MASK = 7  // Read physical raster position (bit mask)
...
.var VIC4_SHDEMU_MASK = 64  // Enable simulated shadow-mask (PALEMU must also be enabled) (bit mask)
.var SHDEMU_MASK = 64  // Enable simulated shadow-mask (PALEMU must also be enabled) (bit mask)
...
.var VIC4_FNRST_MASK = 128  // Raster compare source (0=VIC-IV fine raster, 1=VIC-II raster) (bit mask)
.var FNRST_MASK = 128  // Raster compare source (0=VIC-IV fine raster, 1=VIC-II raster) (bit mask)
...
.var VIC4_CHR16_MASK = 1  // enable 16-bit character numbers (two screen bytes per character) (bit mask)
.var CHR16_MASK = 1  // enable 16-bit character numbers (two screen bytes per character) (bit mask)
...
.var VIC4_FCLRLO_MASK = 2  // enable full-colour mode for character numbers <=$FF (bit mask)
.var FCLRLO_MASK = 2  // enable full-colour mode for character numbers <=$FF (bit mask)
...
.var VIC4_FCLRHI_MASK = 4  // enable full-colour mode for character numbers >$FF (bit mask)
.var FCLRHI_MASK = 4  // enable full-colour mode for character numbers >$FF (bit mask)
...
.var VIC4_SMTH_MASK = 8  // video output horizontal smoothing enable (bit mask)
.var SMTH_MASK = 8  // video output horizontal smoothing enable (bit mask)
.var VIC4_SPR640_ADDR = $D054  // Sprite H640 enable; (address)
.var SPR640_ADDR = $D054  // Sprite H640 enable; (address)
.var VIC4_SPR640_MASK = 16  // Sprite H640 enable; (bit mask)
.var SPR640_MASK = 16  // Sprite H640 enable; (bit mask)
...
.var VIC4_PALEMU_MASK = 32  // Enable PAL CRT-like scan-line emulation (bit mask)
.var PALEMU_MASK = 32  // Enable PAL CRT-like scan-line emulation (bit mask)
.var VIC4_VFAST_ADDR = $D054  // C65GS FAST mode (48MHz) (address)
.var VFAST_ADDR = $D054  // C65GS FAST mode (48MHz) (address)
.var VIC4_VFAST_MASK = 64  // C65GS FAST mode (48MHz) (bit mask)
.var VFAST_MASK = 64  // C65GS FAST mode (48MHz) (bit mask)
.var VIC4_ALPHEN_ADDR = $D054  // Alpha compositor enable (address)
.var ALPHEN_ADDR = $D054  // Alpha compositor enable (address)
.var VIC4_ALPHEN_MASK = 128  // Alpha compositor enable (bit mask)
.var ALPHEN_MASK = 128  // Alpha compositor enable (bit mask)
...
.var VIC4_SDBDRWD_MSB_MASK = 63  // side border width (MSB) (bit mask)
.var SDBDRWD_MSB_MASK = 63  // side border width (MSB) (bit mask)
...
.var VIC4_RST_DELEN_MASK = 64  // Enable raster delay (delays raster counter and interrupts by one line to match output pipeline latency) (bit mask)
.var RST_DELEN_MASK = 64  // Enable raster delay (delays raster counter and interrupts by one line to match output pipeline latency) (bit mask)
...
.var VIC4_HOTREG_MASK = 128  // Enable VIC-II hot registers. When enabled, touching many VIC-II registers causes the VIC-IV to recalculate display parameters, such as border positions and sizes (bit mask)
.var HOTREG_MASK = 128  // Enable VIC-II hot registers. When enabled, touching many VIC-II registers causes the VIC-IV to recalculate display parameters, such as border positions and sizes (bit mask)
...
.var VIC4_SCRNPTRMB_MASK = 15  // screen RAM precise base address (bits 31 - 24) (bit mask)
.var SCRNPTRMB_MASK = 15  // screen RAM precise base address (bits 31 - 24) (bit mask)
...
.var VIC4_CHRCOUNT_MASK = 48  // Number of characters to display per (bit mask)
.var CHRCOUNT_MASK = 48  // Number of characters to display per (bit mask)
...
.var VIC4_EXGLYPH_MASK = 128  // source full-colour character data from expansion RAM (bit mask)
.var EXGLYPH_MASK = 128  // source full-colour character data from expansion RAM (bit mask)
...
.var VIC4_SPRPTRBNK_MASK = 127  // sprite pointer address (bits 23 - 16) (bit mask)
.var SPRPTRBNK_MASK = 127  // sprite pointer address (bits 23 - 16) (bit mask)
...
.var VIC4_SPR_PTR16_MASK = 128  // 16-bit sprite pointer mode (allows sprites to be located on any 64 byte boundary in chip RAM) (bit mask)
.var SPR_PTR16_MASK = 128  // 16-bit sprite pointer mode (allows sprites to be located on any 64 byte boundary in chip RAM) (bit mask)
.var VIC4_RASLINE0_ADDR = $D06F  // first VIC-II raster line (address)
.var RASLINE0_ADDR = $D06F  // first VIC-II raster line (address)
.var VIC4_RASLINE0_MASK = 63  // first VIC-II raster line (bit mask)
.var RASLINE0_MASK = 63  // first VIC-II raster line (bit mask)
...
.var VIC4_VGAHDTV_MASK = 64  // Select more VGA-compatible mode if set, instead of HDMI/HDTV VIC-II cycle-exact frame timing. May help to produce a functional display on older VGA monitors. (bit mask)
.var VGAHDTV_MASK = 64  // Select more VGA-compatible mode if set, instead of HDMI/HDTV VIC-II cycle-exact frame timing. May help to produce a functional display on older VGA monitors. (bit mask)
...
.var VIC4_PALNTSC_MASK = 128  // NTSC emulation mode (max raster = 262) (bit mask)
.var PALNTSC_MASK = 128  // NTSC emulation mode (max raster = 262) (bit mask)
...
.var VIC4_ABTPALSEL_MASK = 3  // VIC-IV bitmap/text palette bank (alternate palette) (bit mask)
.var ABTPALSEL_MASK = 3  // VIC-IV bitmap/text palette bank (alternate palette) (bit mask)
.var VIC4_SPRPALSEL_ADDR = $D070  // sprite palette bank (address)
.var SPRPALSEL_ADDR = $D070  // sprite palette bank (address)
.var VIC4_SPRPALSEL_MASK = 12  // sprite palette bank (bit mask)
.var SPRPALSEL_MASK = 12  // sprite palette bank (bit mask)
.var VIC4_BTPALSEL_ADDR = $D070  // bitmap/text palette bank (address)
.var BTPALSEL_ADDR = $D070  // bitmap/text palette bank (address)
.var VIC4_BTPALSEL_MASK = 48  // bitmap/text palette bank (bit mask)
.var BTPALSEL_MASK = 48  // bitmap/text palette bank (bit mask)
...
.var VIC4_MAPEDPAL_MASK = 192  // palette bank mapped at $D100-$D3FF (bit mask)
.var MAPEDPAL_MASK = 192  // palette bank mapped at $D100-$D3FF (bit mask)
...
.var VIC4_ALPHADELAY_MASK = 15  // Alpha delay for compositor (bit mask)
.var ALPHADELAY_MASK = 15  // Alpha delay for compositor (bit mask)
...
.var VIC4_RASTERHEIGHT_MASK = 240  // physical rasters per VIC-II raster (1 to 16) (bit mask)
.var RASTERHEIGHT_MASK = 240  // physical rasters per VIC-II raster (1 to 16) (bit mask)
...
.var VIC4_RSTCMP_MASK = 7  // Raster compare value MSB (bit mask)
.var RSTCMP_MASK = 7  // Raster compare value MSB (bit mask)
...
.var VIC4_SPTR_CONT_MASK = 8  // Continuously monitor sprite pointer, to allow changing sprite data source while a sprite is being drawn (bit mask)
.var SPTR_CONT_MASK = 8  // Continuously monitor sprite pointer, to allow changing sprite data source while a sprite is being drawn (bit mask)
.var VIC4_RESV_ADDR = $D07A  // Reserved. (address)
.var VIC4_RESV_MASK = 48  // Reserved. (bit mask)
...
.var VIC4_EXTIRQS_MASK = 64  // Enable additional IRQ sources, e.g., raster X position. (bit mask)
.var EXTIRQS_MASK = 64  // Enable additional IRQ sources, e.g., raster X position. (bit mask)
...
.var VIC4_FNRST_CMP_MASK = 128  // Raster compare is in physical rasters if set, or VIC-II raster if clear (bit mask)
.var FNRST_CMP_MASK = 128  // Raster compare is in physical rasters if set, or VIC-II raster if clear (bit mask)
...
.var VIC4_BIT_PBANK_MASK = 7  // Set which 128KB bank bitplanes (bit mask)
.var BIT_PBANK_MASK = 7  // Set which 128KB bank bitplanes (bit mask)
.var GS_VIC4_RESV_ADDR = $D07C  // @RESV (address)
.var GS_VIC4_RESV_MASK = 8  // @RESV (bit mask)
.var VIC4_HSYNCP_ADDR = $D07C  // hsync polarity (address)
.var HSYNCP_ADDR = $D07C  // hsync polarity (address)
.var VIC4_HSYNCP_MASK = 16  // hsync polarity (bit mask)
.var HSYNCP_MASK = 16  // hsync polarity (bit mask)
.var VIC4_VSYNCP_ADDR = $D07C  // vsync polarity (address)
.var VSYNCP_ADDR = $D07C  // vsync polarity (address)
.var VIC4_VSYNCP_MASK = 32  // vsync polarity (bit mask)
.var VSYNCP_MASK = 32  // vsync polarity (bit mask)
...
.var VIC4_DEBUGC_MASK = 192  // VIC-IV debug pixel select red(01), green(10) or blue(11) channel visible in $D07D (bit mask)
.var DEBUGC_MASK = 192  // VIC-IV debug pixel select red(01), green(10) or blue(11) channel visible in $D07D (bit mask)
...
.var DEBUG_DEBUGX_MASK = 15  // VIC-IV debug X position (MSB) (bit mask)
.var DEBUGX_MASK = 15  // VIC-IV debug X position (MSB) (bit mask)
.var DEBUG_DEBUGY_ADDR = $D07F  // VIC-IV debug Y position (MSB) (address)
.var DEBUGY_ADDR = $D07F  // VIC-IV debug Y position (MSB) (address)
.var DEBUG_DEBUGY_MASK = 240  // VIC-IV debug Y position (MSB) (bit mask)
.var DEBUGY_MASK = 240  // VIC-IV debug Y position (MSB) (bit mask)
...
.var DEBUG_DEBUGOOF_MASK = 128  // VIC-IV debug out-of-frame signal enable (bit mask)
.var DEBUGOOF_MASK = 128  // VIC-IV debug out-of-frame signal enable (bit mask)
...
.var FDC_DS_MASK = 7  // Drive select (0 to 7). Internal drive is 0. Second floppy drive on internal cable is 1. Other values reserved for C1565 external drive interface. (bit mask)
.var DS_MASK = 7  // Drive select (0 to 7). Internal drive is 0. Second floppy drive on internal cable is 1. Other values reserved for C1565 external drive interface. (bit mask)
...
.var FDC_SIDE_MASK = 8  // Directly controls the SIDE signal to the floppy drive, i.e., selecting which side of the media is active. (bit mask)
.var SIDE_MASK = 8  // Directly controls the SIDE signal to the floppy drive, i.e., selecting which side of the media is active. (bit mask)
...
.var FDC_SWAP_MASK = 16  // Swap upper and lower halves of data buffer (i.e. invert bit 8 of the sector buffer) (bit mask)
.var SWAP_MASK = 16  // Swap upper and lower halves of data buffer (i.e. invert bit 8 of the sector buffer) (bit mask)
...
.var FDC_MOTOR_MASK = 32  // Activates drive motor and LED (unless LED signal is also set, causing the drive LED to blink) (bit mask)
.var MOTOR_MASK = 32  // Activates drive motor and LED (unless LED signal is also set, causing the drive LED to blink) (bit mask)
.var FDC_LED_ADDR = $D080  // Drive LED blinks when set (address)
.var FDC_LED_MASK = 64  // Drive LED blinks when set (bit mask)
...
.var FDC_IRQ_MASK = 128  // When set, enables interrupts to occur. Clearing clears any pending interrupt and disables interrupts until set again. (bit mask)
...
.var FDC_NOBUF_MASK = 1  // Reset the sector buffer read/write pointers (bit mask)
.var NOBUF_MASK = 1  // Reset the sector buffer read/write pointers (bit mask)
...
.var FDC_ALT_MASK = 2  // Selects alternate DPLL read recovery method (not implemented) (bit mask)
.var ALT_MASK = 2  // Selects alternate DPLL read recovery method (not implemented) (bit mask)
...
.var FDC_ALGO_MASK = 4  // Selects reading and writing algorithm (currently ignored). (bit mask)
.var ALGO_MASK = 4  // Selects reading and writing algorithm (currently ignored). (bit mask)
...
.var FDC_DIR_MASK = 8  // Sets the stepping direction (inward vs (bit mask)
.var DIR_MASK = 8  // Sets the stepping direction (inward vs (bit mask)
...
.var FDC_STEP_MASK = 16  // Writing 1 causes the head to step in the indicated direction (bit mask)
.var STEP_MASK = 16  // Writing 1 causes the head to step in the indicated direction (bit mask)
...
.var FDC_FREE_MASK = 32  // Command is a free-format (low level) operation (bit mask)
.var FREE_MASK = 32  // Command is a free-format (low level) operation (bit mask)
...
.var FDC_RDCMD_MASK = 64  // Command is a read operation if set (bit mask)
.var RDCMD_MASK = 64  // Command is a read operation if set (bit mask)
...
.var FDC_WRCMD_MASK = 128  // Command is a write operation if set (bit mask)
.var WRCMD_MASK = 128  // Command is a write operation if set (bit mask)
...
.var FDC_TK0_MASK = 1  // F011 Head is over track 0 flag (read only) (bit mask)
.var TK0_MASK = 1  // F011 Head is over track 0 flag (read only) (bit mask)
...
.var FDC_PROT_MASK = 2  // F011 Disk write protect flag (read only) (bit mask)
.var PROT_MASK = 2  // F011 Disk write protect flag (read only) (bit mask)
...
.var FDC_LOST_MASK = 4  // F011 LOST flag (data was lost during transfer, i.e., CPU did not read data fast enough) (read only) (bit mask)
.var LOST_MASK = 4  // F011 LOST flag (data was lost during transfer, i.e., CPU did not read data fast enough) (read only) (bit mask)
...
.var FDC_CRC_MASK = 8  // F011 FDC CRC check failure flag (read only) (bit mask)
.var CRC_MASK = 8  // F011 FDC CRC check failure flag (read only) (bit mask)
...
.var FDC_RNF_MASK = 16  // F011 FDC Request Not Found (RNF), i.e., a sector read or write operation did not find the requested sector (read only) (bit mask)
.var RNF_MASK = 16  // F011 FDC Request Not Found (RNF), i.e., a sector read or write operation did not find the requested sector (read only) (bit mask)
...
.var FDC_EQ_MASK = 32  // F011 FDC CPU and disk pointers to sector buffer are equal, indicating that the sector buffer is either full or empty. (read only) (bit mask)
.var EQ_MASK = 32  // F011 FDC CPU and disk pointers to sector buffer are equal, indicating that the sector buffer is either full or empty. (read only) (bit mask)
...
.var FDC_DRQ_MASK = 64  // F011 FDC DRQ flag (one or more bytes of data are ready) (read only) (bit mask)
.var DRQ_MASK = 64  // F011 FDC DRQ flag (one or more bytes of data are ready) (read only) (bit mask)
...
.var FDC_BUSY_MASK = 128  // F011 FDC busy flag (command is being executed) (read only) (bit mask)
.var BUSY_MASK = 128  // F011 FDC busy flag (command is being executed) (read only) (bit mask)
...
.var FDC_DSKCHG_MASK = 1  // F011 disk change sense (read only) (bit mask)
.var DSKCHG_MASK = 1  // F011 disk change sense (read only) (bit mask)
...
.var C65_FDC_IRQ_MASK = 2  // The floppy controller has generated an interrupt (read only). Note that interrupts are not currently implemented on the 45GS27. (bit mask)
...
.var FDC_INDEX_MASK = 4  // F011 Index hole sense (read only) (bit mask)
.var INDEX_MASK = 4  // F011 Index hole sense (read only) (bit mask)
.var FDC_DISKIN_ADDR = $D083  // F011 Disk sense (read only) (address)
.var DISKIN_ADDR = $D083  // F011 Disk sense (read only) (address)
.var FDC_DISKIN_MASK = 8  // F011 Disk sense (read only) (bit mask)
.var DISKIN_MASK = 8  // F011 Disk sense (read only) (bit mask)
...
.var FDC_WGATE_MASK = 16  // F011 write gate flag. Indicates that the drive is currently writing to media. Bad things may happen if a write transaction is aborted (read only) (bit mask)
.var WGATE_MASK = 16  // F011 write gate flag. Indicates that the drive is currently writing to media. Bad things may happen if a write transaction is aborted (read only) (bit mask)
...
.var FDC_RUN_MASK = 32  // F011 Successive match. A synonym of RDREQ on the 45IO47 (read only) (bit mask)
.var RUN_MASK = 32  // F011 Successive match. A synonym of RDREQ on the 45IO47 (read only) (bit mask)
...
.var FDC_WTREQ_MASK = 64  // F011 Write Request flag, i.e., the requested sector was found during a write operation (read only) (bit mask)
.var WTREQ_MASK = 64  // F011 Write Request flag, i.e., the requested sector was found during a write operation (read only) (bit mask)
...
.var FDC_RDREQ_MASK = 128  // F011 Read Request flag, i.e., the requested sector was found during a read operation (read only) (bit mask)
.var RDREQ_MASK = 128  // F011 Read Request flag, i.e., the requested sector was found during a read operation (read only) (bit mask)
...
.var UART_RXRDY_MASK = 1  // UART RX byte ready flag (clear by reading \$D600) (bit mask)
.var RXRDY_MASK = 1  // UART RX byte ready flag (clear by reading \$D600) (bit mask)
...
.var UART_RXOVRRUN_MASK = 2  // UART RX overrun flag (clear by reading \$D600) (bit mask)
.var RXOVRRUN_MASK = 2  // UART RX overrun flag (clear by reading \$D600) (bit mask)
...
.var UART_PTYERR_MASK = 4  // UART RX parity error flag (clear by reading \$D600) (bit mask)
.var PTYERR_MASK = 4  // UART RX parity error flag (clear by reading \$D600) (bit mask)
...
.var UART_FRMERR_MASK = 8  // UART RX framing error flag (clear by reading \$D600) (bit mask)
.var FRMERR_MASK = 8  // UART RX framing error flag (clear by reading \$D600) (bit mask)
.var UART_PTYEVEN_ADDR = $D602  // UART Parity: 1=even, 0=odd (address)
.var PTYEVEN_ADDR = $D602  // UART Parity: 1=even, 0=odd (address)
.var UART_PTYEVEN_MASK = 1  // UART Parity: 1=even, 0=odd (bit mask)
.var PTYEVEN_MASK = 1  // UART Parity: 1=even, 0=odd (bit mask)
.var UART_PTYEN_ADDR = $D602  // UART Parity enable: 1=enabled (address)
.var PTYEN_ADDR = $D602  // UART Parity enable: 1=enabled (address)
.var UART_PTYEN_MASK = 2  // UART Parity enable: 1=enabled (bit mask)
.var PTYEN_MASK = 2  // UART Parity enable: 1=enabled (bit mask)
...
.var UART_CHARSZ_MASK = 12  // UART character size: 00=8, 01=7, 10=6, 11=5 bits per byte (bit mask)
.var CHARSZ_MASK = 12  // UART character size: 00=8, 01=7, 10=6, 11=5 bits per byte (bit mask)
...
.var UART_SYNCMOD_MASK = 48  // UART synchronisation mode flags (00=RX \& TX both async, 01=RX sync, TX async, 1x=TX sync, RX async (unused on the MEGA65) (bit mask)
.var SYNCMOD_MASK = 48  // UART synchronisation mode flags (00=RX \& TX both async, 01=RX sync, TX async, 1x=TX sync, RX async (unused on the MEGA65) (bit mask)
.var UART_RXEN_ADDR = $D602  // UART enable receive (address)
.var RXEN_ADDR = $D602  // UART enable receive (address)
.var UART_RXEN_MASK = 64  // UART enable receive (bit mask)
.var RXEN_MASK = 64  // UART enable receive (bit mask)
.var UART_TXEN_ADDR = $D602  // UART enable transmit (address)
.var TXEN_ADDR = $D602  // UART enable transmit (address)
.var UART_TXEN_MASK = 128  // UART enable transmit (bit mask)
.var TXEN_MASK = 128  // UART enable transmit (bit mask)
...
.var UART_IMRXNMI_MASK = 16  // UART interrupt mask: NMI on RX (not yet implemented on the MEGA65) (bit mask)
.var IMRXNMI_MASK = 16  // UART interrupt mask: NMI on RX (not yet implemented on the MEGA65) (bit mask)
...
.var UART_IMTXNMI_MASK = 32  // UART interrupt mask: NMI on TX (not yet implemented on the MEGA65) (bit mask)
.var IMTXNMI_MASK = 32  // UART interrupt mask: NMI on TX (not yet implemented on the MEGA65) (bit mask)
...
.var UART_IMRXIRQ_MASK = 64  // UART interrupt mask: IRQ on RX (not yet implemented on the MEGA65) (bit mask)
.var IMRXIRQ_MASK = 64  // UART interrupt mask: IRQ on RX (not yet implemented on the MEGA65) (bit mask)
...
.var UART_IMTXIRQ_MASK = 128  // UART interrupt mask: IRQ on TX (not yet implemented on the MEGA65) (bit mask)
.var IMTXIRQ_MASK = 128  // UART interrupt mask: IRQ on TX (not yet implemented on the MEGA65) (bit mask)
...
.var UART_IFRXNMI_MASK = 16  // UART interrupt flag: NMI on RX (not yet implemented on the MEGA65) (bit mask)
.var IFRXNMI_MASK = 16  // UART interrupt flag: NMI on RX (not yet implemented on the MEGA65) (bit mask)
...
.var UART_IFTXNMI_MASK = 32  // UART interrupt flag: NMI on TX (not yet implemented on the MEGA65) (bit mask)
.var IFTXNMI_MASK = 32  // UART interrupt flag: NMI on TX (not yet implemented on the MEGA65) (bit mask)
...
.var UART_IFRXIRQ_MASK = 64  // UART interrupt flag: IRQ on RX (not yet implemented on the MEGA65) (bit mask)
.var IFRXIRQ_MASK = 64  // UART interrupt flag: IRQ on RX (not yet implemented on the MEGA65) (bit mask)
...
.var UART_IFTXIRQ_MASK = 128  // UART interrupt flag: IRQ on TX (not yet implemented on the MEGA65) (bit mask)
.var IFTXIRQ_MASK = 128  // UART interrupt flag: IRQ on TX (not yet implemented on the MEGA65) (bit mask)
.var UART_CAPLOCK_ADDR = $D607  // C65 capslock key sense (address)
.var CAPLOCK_ADDR = $D607  // C65 capslock key sense (address)
.var UART_CAPLOCK_MASK = 1  // C65 capslock key sense (bit mask)
.var CAPLOCK_MASK = 1  // C65 capslock key sense (bit mask)
...
.var UART_KEYCOL8_MASK = 2  // C65 keyboard column 8 select (bit mask)
.var KEYCOL8_MASK = 2  // C65 keyboard column 8 select (bit mask)
...
.var UART_PORTEDDR_MASK = 3  // C65 keyboard extra lines Data Direction Register (DDR) (bit mask)
.var PORTEDDR_MASK = 3  // C65 keyboard extra lines Data Direction Register (DDR) (bit mask)
...
.var UARTMISC_UFAST_MASK = 1  // C65 UART BAUD clock source: 1 = 7.09375MHz, 0 = 80MHz (VIC-IV pixel clock) (bit mask)
.var UFAST_MASK = 1  // C65 UART BAUD clock source: 1 = 7.09375MHz, 0 = 80MHz (VIC-IV pixel clock) (bit mask)
...
.var UARTMISC_PORTF_MASK = 63  // PMOD port A on FPGA board (data) (Nexys4 boards only) (bit mask)
.var PORTF_MASK = 63  // PMOD port A on FPGA board (data) (Nexys4 boards only) (bit mask)
...
.var UARTMISC_OSKZON_MASK = 64  // Display hardware zoom of region under first touch point always (bit mask)
.var OSKZON_MASK = 64  // Display hardware zoom of region under first touch point always (bit mask)
...
.var UARTMISC_OSKZEN_MASK = 128  // Display hardware zoom of region under first touch point for on-screen keyboard (bit mask)
.var OSKZEN_MASK = 128  // Display hardware zoom of region under first touch point for on-screen keyboard (bit mask)
.var UARTMISC_PORTFDDR_ADDR = $D60C  // PMOD port A on FPGA board (DDR) (address)
.var UARTMISC_PORTFDDR_MASK = 63  // PMOD port A on FPGA board (DDR) (bit mask)
...
.var GS_UARTMISC_PORTFDDR_MASK = 192  // On Screen Keyboard (OSK) Zoom Control Data Direction Register (DDR). Must be set to output to control these features. (bit mask)
...
.var UARTMISC_CONN41_MASK = 1  // Internal 1541 drive connect (1=connect internal 1541 drive to IEC bus) (bit mask)
.var CONN41_MASK = 1  // Internal 1541 drive connect (1=connect internal 1541 drive to IEC bus) (bit mask)
...
.var UARTMISC_RST41_MASK = 2  // Internal 1541 drive reset (1=reset, 0=operate) (bit mask)
.var RST41_MASK = 2  // Internal 1541 drive reset (1=reset, 0=operate) (bit mask)
.var UARTMISC_SDDATA_ADDR = $D60D  // SD card MOSI/MISO (address)
.var SDDATA_ADDR = $D60D  // SD card MOSI/MISO (address)
.var UARTMISC_SDDATA_MASK = 4  // SD card MOSI/MISO (bit mask)
.var SDDATA_MASK = 4  // SD card MOSI/MISO (bit mask)
.var UARTMISC_SDCLK_ADDR = $D60D  // SD card SCLK (address)
.var SDCLK_ADDR = $D60D  // SD card SCLK (address)
.var UARTMISC_SDCLK_MASK = 8  // SD card SCLK (bit mask)
.var SDCLK_MASK = 8  // SD card SCLK (bit mask)
.var UARTMISC_SDCS_ADDR = $D60D  // SD card CS_BO (address)
.var SDCS_ADDR = $D60D  // SD card CS_BO (address)
.var UARTMISC_SDCS_MASK = 16  // SD card CS_BO (bit mask)
.var SDCS_MASK = 16  // SD card CS_BO (bit mask)
.var UARTMISC_SDBSH_ADDR = $D60D  // Enable SD card bitbash mode (address)
.var SDBSH_ADDR = $D60D  // Enable SD card bitbash mode (address)
.var UARTMISC_SDBSH_MASK = 32  // Enable SD card bitbash mode (bit mask)
.var SDBSH_MASK = 32  // Enable SD card bitbash mode (bit mask)
...
.var UARTMISC_HDSDA_MASK = 64  // HDMI I2C control interface SDA data line (bit mask)
.var HDSDA_MASK = 64  // HDMI I2C control interface SDA data line (bit mask)
...
.var UARTMISC_HDSCL_MASK = 128  // HDMI I2C control interface SCL clock (bit mask)
.var HDSCL_MASK = 128  // HDMI I2C control interface SCL clock (bit mask)
...
.var UARTMISC_KEYLEFT_MASK = 1  // Directly read C65 Cursor left key (bit mask)
.var KEYLEFT_MASK = 1  // Directly read C65 Cursor left key (bit mask)
...
.var UARTMISC_KEYUP_MASK = 2  // Directly read C65 Cursor up key (bit mask)
.var KEYUP_MASK = 2  // Directly read C65 Cursor up key (bit mask)
...
.var UARTMISC_REALHW_MASK = 32  // Set to 1 if the MEGA65 is running on real hardware, set to 0 if emulated (Xemu) or simulated (ghdl) (bit mask)
.var REALHW_MASK = 32  // Set to 1 if the MEGA65 is running on real hardware, set to 0 if emulated (Xemu) or simulated (ghdl) (bit mask)
...
.var UARTMISC_OSKDIM_MASK = 64  // Light or heavy dimming of background material behind on-screen keyboard (bit mask)
.var OSKDIM_MASK = 64  // Light or heavy dimming of background material behind on-screen keyboard (bit mask)
...
.var UARTMISC_ACCESSKEY_MASK = 128  // Enable accessible keyboard input via joystick port 2 fire button (bit mask)
.var ACCESSKEY_MASK = 128  // Enable accessible keyboard input via joystick port 2 fire button (bit mask)
...
.var UARTMISC_MRSHFT_MASK = 1  // Right shift key state (hardware accelerated keyboard scanner). (bit mask)
.var MRSHFT_MASK = 1  // Right shift key state (hardware accelerated keyboard scanner). (bit mask)
...
.var UARTMISC_MLSHFT_MASK = 2  // Left shift key state (hardware accelerated keyboard scanner). (bit mask)
.var MLSHFT_MASK = 2  // Left shift key state (hardware accelerated keyboard scanner). (bit mask)
...
.var UARTMISC_MCTRL_MASK = 4  // CTRL key state (hardware accelerated keyboard scanner). (bit mask)
.var MCTRL_MASK = 4  // CTRL key state (hardware accelerated keyboard scanner). (bit mask)
...
.var UARTMISC_MMEGA_MASK = 8  // MEGA/C= key state (hardware accelerated keyboard scanner). (bit mask)
.var MMEGA_MASK = 8  // MEGA/C= key state (hardware accelerated keyboard scanner). (bit mask)
...
.var UARTMISC_MALT_MASK = 16  // ALT key state (hardware accelerated keyboard scanner). (bit mask)
.var MALT_MASK = 16  // ALT key state (hardware accelerated keyboard scanner). (bit mask)
...
.var UARTMISC_MSCRL_MASK = 32  // NOSCRL key state (hardware accelerated keyboard scanner). (bit mask)
.var MSCRL_MASK = 32  // NOSCRL key state (hardware accelerated keyboard scanner). (bit mask)
...
.var UARTMISC_MCAPS_MASK = 64  // CAPS LOCK key state (hardware accelerated keyboard scanner). (bit mask)
.var MCAPS_MASK = 64  // CAPS LOCK key state (hardware accelerated keyboard scanner). (bit mask)
...
.var UARTMISC_WGTKEY_MASK = 1  // Enable widget board keyboard/joystick input (bit mask)
.var WGTKEY_MASK = 1  // Enable widget board keyboard/joystick input (bit mask)
...
.var UARTMISC_PS2KEY_MASK = 2  // Enable ps2 keyboard/joystick input (bit mask)
.var PS2KEY_MASK = 2  // Enable ps2 keyboard/joystick input (bit mask)
...
.var UARTMISC_PHYKEY_MASK = 4  // Enable physical keyboard input (bit mask)
.var PHYKEY_MASK = 4  // Enable physical keyboard input (bit mask)
...
.var UARTMISC_VRTKEY_MASK = 8  // Enable virtual/snythetic keyboard input (bit mask)
.var VRTKEY_MASK = 8  // Enable virtual/snythetic keyboard input (bit mask)
...
.var UARTMISC_OSKDEBUG_MASK = 16  // Debug OSK overlay (WRITE ONLY) (bit mask)
.var OSKDEBUG_MASK = 16  // Debug OSK overlay (WRITE ONLY) (bit mask)
...
.var UARTMISC_PS2JOY_MASK = 16  // Enable PS/2 / USB keyboard simulated joystick input (bit mask)
.var PS2JOY_MASK = 16  // Enable PS/2 / USB keyboard simulated joystick input (bit mask)
...
.var UARTMISC_JOYSWAP_MASK = 32  // Exchange joystick ports 1 \& 2 (bit mask)
.var JOYSWAP_MASK = 32  // Exchange joystick ports 1 \& 2 (bit mask)
...
.var UARTMISC_LJOYA_MASK = 64  // Rotate inputs of joystick A by 180 degrees (for left handed use) (bit mask)
.var LJOYA_MASK = 64  // Rotate inputs of joystick A by 180 degrees (for left handed use) (bit mask)
...
.var UARTMISC_LJOYB_MASK = 128  // Rotate inputs of joystick B by 180 degrees (for left handed use) (bit mask)
.var LJOYB_MASK = 128  // Rotate inputs of joystick B by 180 degrees (for left handed use) (bit mask)
...
.var UARTMISC_VIRTKEY1_MASK = 127  // Set to \$7F for no key down, else specify virtual key press. (bit mask)
.var VIRTKEY1_MASK = 127  // Set to \$7F for no key down, else specify virtual key press. (bit mask)
...
.var UARTMISC_OSKEN_MASK = 128  // Enable display of on-screen keyboard composited overlay (bit mask)
.var OSKEN_MASK = 128  // Enable display of on-screen keyboard composited overlay (bit mask)
...
.var UARTMISC_VIRTKEY2_MASK = 127  // Set to \$7F for no key down, else specify 2nd virtual key press. (bit mask)
.var VIRTKEY2_MASK = 127  // Set to \$7F for no key down, else specify 2nd virtual key press. (bit mask)
...
.var UARTMISC_OSKALT_MASK = 128  // Display alternate on-screen keyboard layout (typically dial pad for MEGA65 telephone) (bit mask)
.var OSKALT_MASK = 128  // Display alternate on-screen keyboard layout (typically dial pad for MEGA65 telephone) (bit mask)
...
.var UARTMISC_VIRTKEY3_MASK = 127  // Set to \$7F for no key down, else specify 3nd virtual key press. (bit mask)
.var VIRTKEY3_MASK = 127  // Set to \$7F for no key down, else specify 3nd virtual key press. (bit mask)
...
.var UARTMISC_OSKTOP_MASK = 128  // 1=Display on-screen keyboard at top, 0=Disply on-screen keyboard at bottom of screen. (bit mask)
.var OSKTOP_MASK = 128  // 1=Display on-screen keyboard at top, 0=Disply on-screen keyboard at bottom of screen. (bit mask)
...
.var SYSCTL_AUDMUTE_MASK = 1  // Mute digital video audio (MEGA65 R2 only) (bit mask)
.var AUDMUTE_MASK = 1  // Mute digital video audio (MEGA65 R2 only) (bit mask)
...
.var SYSCTL_DVI_MASK = 2  // Control digital video as DVI (disables audio) (bit mask)
.var DVI_MASK = 2  // Control digital video as DVI (disables audio) (bit mask)
...
.var SYSCTL_AUDDBG_MASK = 4  // Visualise audio samples (DEBUG) (bit mask)
.var AUDDBG_MASK = 4  // Visualise audio samples (DEBUG) (bit mask)
...
.var SYSCTL_AUD48K_MASK = 8  // Select 48KHz or 44.1KHz digital video audio sample rate (bit mask)
.var AUD48K_MASK = 8  // Select 48KHz or 44.1KHz digital video audio sample rate (bit mask)
.var SYSCTL_LED_ADDR = $D61A  // Control LED next to U1 on mother board (address)
.var SYSCTL_LED_MASK = 16  // Control LED next to U1 on mother board (bit mask)
...
.var SYSCTL_AUDINV_MASK = 128  // Invert digital video audio sample values (bit mask)
.var AUDINV_MASK = 128  // Invert digital video audio sample values (bit mask)
...
.var UARTMISC_Keyboard_MASK = 127  // LED register select (R,G,B channels x 4 = 0 to 11) (bit mask)
.var GS_UARTMISC_Keyboard_ADDR = $D61D  // LED control enable (address)
.var GS_UARTMISC_Keyboard_MASK = 128  // LED control enable (bit mask)
...
.var SID_SIDMODE_MASK = 15  // Select SID mode: 0=6581, 1=8580 (bit mask)
.var SIDMODE_MASK = 15  // Select SID mode: 0=6581, 1=8580 (bit mask)
...
.var AUDIOMIX_DCTRKEN_MASK = 16  // Enable DC offset subtraction in audio mixer (bit mask)
.var DCTRKEN_MASK = 16  // Enable DC offset subtraction in audio mixer (bit mask)
.var DEBUG_RESETSRC_ADDR = $D63C  // Source of last CPU reset (address)
.var RESETSRC_ADDR = $D63C  // Source of last CPU reset (address)
.var DEBUG_RESETSRC_MASK = 224  // Source of last CPU reset (bit mask)
.var RESETSRC_MASK = 224  // Source of last CPU reset (bit mask)
...
.var HCPU_VICMODE_MASK = 3  // VIC-II/VIC-III/VIC-IV mode select (bit mask)
.var VICMODE_MASK = 3  // VIC-II/VIC-III/VIC-IV mode select (bit mask)
...
.var HCPU_EXSID_MASK = 4  // 0=Use internal SIDs, 1=Use external(1) SIDs (bit mask)
.var EXSID_MASK = 4  // 0=Use internal SIDs, 1=Use external(1) SIDs (bit mask)
...
.var HCPU_VFLOP_MASK = 1  // 1=Virtualise SD/Floppy0 access (usually for access via serial debugger interface) (bit mask)
.var GS_HCPU_VFLOP_ADDR = $D659  // 1=Virtualise SD/Floppy1 access (usually for access via serial debugger interface) (address)
.var GS_HCPU_VFLOP_MASK = 2  // 1=Virtualise SD/Floppy1 access (usually for access via serial debugger interface) (bit mask)
...
.var HCPU_MATRIXEN_MASK = 64  // Enable composited Matrix Mode, and disable UART access to serial monitor. (bit mask)
.var MATRIXEN_MASK = 64  // Enable composited Matrix Mode, and disable UART access to serial monitor. (bit mask)
...
.var HCPU_UARTDATA_MASK = 255  // (write) Hypervisor write serial output to UART monitor (bit mask)
.var UARTDATA_MASK = 255  // (write) Hypervisor write serial output to UART monitor (bit mask)
...
.var HCPU_RSVD_MASK = 1  // RESERVED (bit mask)
.var RSVD_MASK = 1  // RESERVED (bit mask)
...
.var HCPU_JMP32EN_MASK = 2  // Hypervisor enable 32-bit JMP/JSR etc (bit mask)
.var JMP32EN_MASK = 2  // Hypervisor enable 32-bit JMP/JSR etc (bit mask)
...
.var HCPU_ROMPROT_MASK = 4  // Hypervisor write protect C65 ROM \$20000-\$3FFFF (bit mask)
.var ROMPROT_MASK = 4  // Hypervisor write protect C65 ROM \$20000-\$3FFFF (bit mask)
...
.var HCPU_ASCFAST_MASK = 8  // Hypervisor enable ASC/DIN CAPS LOCK key to enable/disable CPU slow-down in C64/C128/C65 modes (bit mask)
.var ASCFAST_MASK = 8  // Hypervisor enable ASC/DIN CAPS LOCK key to enable/disable CPU slow-down in C64/C128/C65 modes (bit mask)
...
.var HCPU_CPUFAST_MASK = 16  // Hypervisor force CPU to 48MHz for userland (userland can override via POKE0) (bit mask)
.var CPUFAST_MASK = 16  // Hypervisor force CPU to 48MHz for userland (userland can override via POKE0) (bit mask)
...
.var HCPU_F4502_MASK = 32  // Hypervisor force CPU to 4502 personality, even in C64 IO mode. (bit mask)
.var F4502_MASK = 32  // Hypervisor force CPU to 4502 personality, even in C64 IO mode. (bit mask)
...
.var HCPU_PIRQ_MASK = 64  // Hypervisor flag to indicate if an IRQ is pending on exit from the hypervisor / set 1 to force IRQ/NMI deferal for 1,024 cycles on exit from hypervisor. (bit mask)
.var PIRQ_MASK = 64  // Hypervisor flag to indicate if an IRQ is pending on exit from the hypervisor / set 1 to force IRQ/NMI deferal for 1,024 cycles on exit from hypervisor. (bit mask)
...
.var HCPU_PNMI_MASK = 128  // Hypervisor flag to indicate if an NMI is pending on exit from the hypervisor. (bit mask)
.var PNMI_MASK = 128  // Hypervisor flag to indicate if an NMI is pending on exit from the hypervisor. (bit mask)
...
.var SD_BUFBIT8_MASK = 1  // (read only) reads bit 8 of the sector buffer pointer (bit mask)
.var BUFBIT8_MASK = 1  // (read only) reads bit 8 of the sector buffer pointer (bit mask)
...
.var SD_BUFFFULL_MASK = 2  // (read only) if set, indicates that the sector buffer is full and has not yet been read (bit mask)
.var BUFFFULL_MASK = 2  // (read only) if set, indicates that the sector buffer is full and has not yet been read (bit mask)
...
.var SD_HNDSHK_MASK = 4  // Set/read SD card sd_handshake signal (bit mask)
.var HNDSHK_MASK = 4  // Set/read SD card sd_handshake signal (bit mask)
.var SD_DRDY_ADDR = $D689  // SD Card Data Ready indication (address)
.var DRDY_ADDR = $D689  // SD Card Data Ready indication (address)
.var SD_DRDY_MASK = 8  // SD Card Data Ready indication (bit mask)
.var DRDY_MASK = 8  // SD Card Data Ready indication (bit mask)
.var SD_RESERVED_ADDR = $D689  // Reserved (address)
.var SD_RESERVED_MASK = 16  // Reserved (bit mask)
...
.var SD_FDCSWAP_MASK = 32  // Set to swap floppy drive 0 (the internal drive) and drive 1 (the drive on the 2nd position on the internal floppy cable). (bit mask)
.var FDCSWAP_MASK = 32  // Set to swap floppy drive 0 (the internal drive) and drive 1 (the drive on the 2nd position on the internal floppy cable). (bit mask)
...
.var SD_BUFFSEL_MASK = 128  // Set to switch sector buffer to view SD card direct access, clear for access to the F011 FDC sector buffer. (bit mask)
.var BUFFSEL_MASK = 128  // Set to switch sector buffer to view SD card direct access, clear for access to the F011 FDC sector buffer. (bit mask)
...
.var SD_CDC00_MASK = 1  // (read only) Set if colour RAM at $DC00 (bit mask)
.var CDC00_MASK = 1  // (read only) Set if colour RAM at $DC00 (bit mask)
...
.var SD_VICIII_MASK = 2  // (read only) Set if VIC-IV or ethernet IO bank visible (bit mask)
.var VICIII_MASK = 2  // (read only) Set if VIC-IV or ethernet IO bank visible (bit mask)
...
.var SD_VFDC0_MASK = 4  // (read only) Set if drive 0 is virtualised (sectors delivered via serial monitor interface) (bit mask)
.var VFDC0_MASK = 4  // (read only) Set if drive 0 is virtualised (sectors delivered via serial monitor interface) (bit mask)
...
.var SD_VFDC1_MASK = 8  // (read only) Set if drive 1 is virtualised (sectors delivered via serial monitor interface) (bit mask)
.var VFDC1_MASK = 8  // (read only) Set if drive 1 is virtualised (sectors delivered via serial monitor interface) (bit mask)
...
.var SDFDC_D0IMG_MASK = 1  // F011 drive 0 use disk image if set, otherwise use real floppy drive. (bit mask)
.var D0IMG_MASK = 1  // F011 drive 0 use disk image if set, otherwise use real floppy drive. (bit mask)
.var SDFDC_D0P_ADDR = $D68B  // F011 drive 0 media present (address)
.var D0P_ADDR = $D68B  // F011 drive 0 media present (address)
.var SDFDC_D0P_MASK = 2  // F011 drive 0 media present (bit mask)
.var D0P_MASK = 2  // F011 drive 0 media present (bit mask)
.var SDFDC_D0WP_ADDR = $D68B  // Write enable F011 drive 0 (address)
.var D0WP_ADDR = $D68B  // Write enable F011 drive 0 (address)
.var SDFDC_D0WP_MASK = 4  // Write enable F011 drive 0 (bit mask)
.var D0WP_MASK = 4  // Write enable F011 drive 0 (bit mask)
...
.var SDFDC_D1IMG_MASK = 8  // F011 drive 1 use disk image if set, otherwise use real floppy drive. (bit mask)
.var D1IMG_MASK = 8  // F011 drive 1 use disk image if set, otherwise use real floppy drive. (bit mask)
.var SDFDC_D1P_ADDR = $D68B  // F011 drive 1 media present (address)
.var D1P_ADDR = $D68B  // F011 drive 1 media present (address)
.var SDFDC_D1P_MASK = 16  // F011 drive 1 media present (bit mask)
.var D1P_MASK = 16  // F011 drive 1 media present (bit mask)
.var SDFDC_D1WP_ADDR = $D68B  // Write enable F011 drive 1 (address)
.var D1WP_ADDR = $D68B  // Write enable F011 drive 1 (address)
.var SDFDC_D1WP_MASK = 32  // Write enable F011 drive 1 (bit mask)
.var D1WP_MASK = 32  // Write enable F011 drive 1 (bit mask)
.var F011_MDISK0_ADDR = $D68B  // Enable 64MiB ``MEGA Disk'' for F011 emulated drive 0 (address)
.var F011_MDISK0_MASK = 64  // Enable 64MiB ``MEGA Disk'' for F011 emulated drive 0 (bit mask)
...
.var SDFDC_D0MD_MASK = 64  // F011 drive 0 disk image is 64MiB mega image if set (otherwise 800KiB 1581 image) (bit mask)
.var D0MD_MASK = 64  // F011 drive 0 disk image is 64MiB mega image if set (otherwise 800KiB 1581 image) (bit mask)
.var GS_F011_MDISK0_ADDR = $D68B  // Enable 64MiB ``MEGA Disk'' for F011 emulated drive 1 (address)
.var GS_F011_MDISK0_MASK = 128  // Enable 64MiB ``MEGA Disk'' for F011 emulated drive 1 (bit mask)
...
.var SDFDC_D1MD_MASK = 128  // F011 drive 1 disk image is 64MiB mega image if set (otherwise 800KiB 1581 image) (bit mask)
.var D1MD_MASK = 128  // F011 drive 1 disk image is 64MiB mega image if set (otherwise 800KiB 1581 image) (bit mask)
...
.var FDC_DBGWGATE_MASK = 1  // Control floppy drive SIDE1 line (bit mask)
.var GS_FDC_DBGWGATE_ADDR = $D6A0  // Control floppy drive WGATE line (address)
.var GS_FDC_DBGWGATE_MASK = 2  // Control floppy drive WGATE line (bit mask)
...
.var FDC_DBGWDATA_MASK = 4  // Control floppy drive WDATA line (bit mask)
.var DBGWDATA_MASK = 4  // Control floppy drive WDATA line (bit mask)
.var FDC_DBGDIR_ADDR = $D6A0  // Control floppy drive STEP line (address)
.var FDC_DBGDIR_MASK = 8  // Control floppy drive STEP line (bit mask)
.var GS_FDC_DBGDIR_ADDR = $D6A0  // Control floppy drive STEPDIR line (address)
.var GS_FDC_DBGDIR_MASK = 16  // Control floppy drive STEPDIR line (bit mask)
.var FDC_DBGMOTORA_ADDR = $D6A0  // Control floppy drive SELECT line (address)
.var FDC_DBGMOTORA_MASK = 32  // Control floppy drive SELECT line (bit mask)
.var GS_FDC_DBGMOTORA_ADDR = $D6A0  // Control floppy drive MOTOR line (address)
.var GS_FDC_DBGMOTORA_MASK = 64  // Control floppy drive MOTOR line (bit mask)
...
.var FDC_DENSITY_MASK = 128  // Control floppy drive density select line (bit mask)
.var DENSITY_MASK = 128  // Control floppy drive density select line (bit mask)
...
.var F011_DRV0EN_MASK = 1  // Use real floppy drive instead of SD card for 1st floppy drive (bit mask)
.var DRV0EN_MASK = 1  // Use real floppy drive instead of SD card for 1st floppy drive (bit mask)
...
.var SDFDC_USEREAL0_MASK = 1  // Use real floppy drive for drive 0 if set (read-only, except for from hypervisor) (bit mask)
.var USEREAL0_MASK = 1  // Use real floppy drive for drive 0 if set (read-only, except for from hypervisor) (bit mask)
...
.var SDFDC_TARGANY_MASK = 2  // Read next sector under head if set, ignoring the requested side, track and sector number. (bit mask)
.var TARGANY_MASK = 2  // Read next sector under head if set, ignoring the requested side, track and sector number. (bit mask)
...
.var F011_DRV2EN_MASK = 4  // Use real floppy drive instead of SD card for 2nd floppy drive (bit mask)
.var DRV2EN_MASK = 4  // Use real floppy drive instead of SD card for 2nd floppy drive (bit mask)
...
.var SDFDC_USEREAL1_MASK = 4  // Use real floppy drive for drive 1 if set (read-only, except for from hypervisor) (bit mask)
.var USEREAL1_MASK = 4  // Use real floppy drive for drive 1 if set (read-only, except for from hypervisor) (bit mask)
...
.var SDFDC_SILENT_MASK = 8  // Disable floppy spinning and tracking for SD card operations. (bit mask)
.var SILENT_MASK = 8  // Disable floppy spinning and tracking for SD card operations. (bit mask)
...
.var MISCIO_WHEEL3TARGET_MASK = 15  // Select audio channel volume to be set by thumb wheel #3 (bit mask)
.var WHEEL3TARGET_MASK = 15  // Select audio channel volume to be set by thumb wheel #3 (bit mask)
...
.var MISCIO_WHEELBRIGHTEN_MASK = 128  // Enable control of LCD panel brightness via thumb wheel (bit mask)
.var WHEELBRIGHTEN_MASK = 128  // Enable control of LCD panel brightness via thumb wheel (bit mask)
...
.var MISCIO_WHEEL1TARGET_MASK = 15  // Select audio channel volume to be set by thumb wheel #1 (bit mask)
.var WHEEL1TARGET_MASK = 15  // Select audio channel volume to be set by thumb wheel #1 (bit mask)
...
.var MISCIO_WHEEL2TARGET_MASK = 240  // Select audio channel volume to be set by thumb wheel #2 (bit mask)
.var WHEEL2TARGET_MASK = 240  // Select audio channel volume to be set by thumb wheel #2 (bit mask)
...
.var SD_FDC_ENC_MASK = 15  // Select floppy encoding (0=MFM, 1=RLL2,7, F=Raw encoding) (bit mask)
.var FDC_ENC_MASK = 15  // Select floppy encoding (0=MFM, 1=RLL2,7, F=Raw encoding) (bit mask)
...
.var SD_AUTO_2XSEL_MASK = 16  // Automatically select DD or HD decoder for last sector display (bit mask)
.var AUTO_2XSEL_MASK = 16  // Automatically select DD or HD decoder for last sector display (bit mask)
...
.var SD_FDC_VARSPD_MASK = 32  // Enable automatic variable speed selection for floppy controller using Track Information Blocks on MEGA65 HD floppies (bit mask)
.var FDC_VARSPD_MASK = 32  // Enable automatic variable speed selection for floppy controller using Track Information Blocks on MEGA65 HD floppies (bit mask)
...
.var SD_FDC_2XSEL_MASK = 64  // Select HD decoder for last sector display (bit mask)
.var FDC_2XSEL_MASK = 64  // Select HD decoder for last sector display (bit mask)
...
.var SD_FDC_TIBEN_MASK = 128  // Enable use of Track Info Block settings (bit mask)
.var FDC_TIBEN_MASK = 128  // Enable use of Track Info Block settings (bit mask)
...
.var SD_VR_FOUND_MASK = 1  // Manually set f011_rsector_found signal (indented for virtual F011 mode only) (bit mask)
.var VR_FOUND_MASK = 1  // Manually set f011_rsector_found signal (indented for virtual F011 mode only) (bit mask)
...
.var SD_VW_FOUND_MASK = 2  // Manually set f011_wsector_found signal (indented for virtual F011 mode only) (bit mask)
.var VW_FOUND_MASK = 2  // Manually set f011_wsector_found signal (indented for virtual F011 mode only) (bit mask)
...
.var SD_VEQ_INH_MASK = 4  // Manually set f011_eq_inhibit signal (indented for virtual F011 mode only) (bit mask)
.var VEQ_INH_MASK = 4  // Manually set f011_eq_inhibit signal (indented for virtual F011 mode only) (bit mask)
...
.var SD_VRNF_MASK = 8  // Manually set f011_rnf signal (indented for virtual F011 mode only) (bit mask)
.var VRNF_MASK = 8  // Manually set f011_rnf signal (indented for virtual F011 mode only) (bit mask)
...
.var SD_VDRQ_MASK = 16  // Manually set f011_drq signal (indented for virtual F011 mode only) (bit mask)
.var VDRQ_MASK = 16  // Manually set f011_drq signal (indented for virtual F011 mode only) (bit mask)
...
.var SD_VLOST_MASK = 32  // Manually set f011_lost signal (indented for virtual F011 mode only) (bit mask)
.var VLOST_MASK = 32  // Manually set f011_lost signal (indented for virtual F011 mode only) (bit mask)
.var TOUCH_EV1_ADDR = $D6B0  // Touch event 1 is valid (address)
.var EV1_ADDR = $D6B0  // Touch event 1 is valid (address)
.var TOUCH_EV1_MASK = 1  // Touch event 1 is valid (bit mask)
.var EV1_MASK = 1  // Touch event 1 is valid (bit mask)
.var TOUCH_EV2_ADDR = $D6B0  // Touch event 2 is valid (address)
.var EV2_ADDR = $D6B0  // Touch event 2 is valid (address)
.var TOUCH_EV2_MASK = 2  // Touch event 2 is valid (bit mask)
.var EV2_MASK = 2  // Touch event 2 is valid (bit mask)
.var TOUCH_UPDN1_ADDR = $D6B0  // Touch event 1 up/down state (address)
.var UPDN1_ADDR = $D6B0  // Touch event 1 up/down state (address)
.var TOUCH_UPDN1_MASK = 12  // Touch event 1 up/down state (bit mask)
.var UPDN1_MASK = 12  // Touch event 1 up/down state (bit mask)
.var TOUCH_UPDN2_ADDR = $D6B0  // Touch event 2 up/down state (address)
.var UPDN2_ADDR = $D6B0  // Touch event 2 up/down state (address)
.var TOUCH_UPDN2_MASK = 48  // Touch event 2 up/down state (bit mask)
.var UPDN2_MASK = 48  // Touch event 2 up/down state (bit mask)
.var MISCIO_TCHFLX_ADDR = $D6B0  // Flip X axis of touch interface if set (address)
.var MISCIO_TCHFLX_MASK = 64  // Flip X axis of touch interface if set (bit mask)
.var TOUCH_XINV_ADDR = $D6B0  // Invert horizontal axis (address)
.var XINV_ADDR = $D6B0  // Invert horizontal axis (address)
.var TOUCH_XINV_MASK = 64  // Invert horizontal axis (bit mask)
.var XINV_MASK = 64  // Invert horizontal axis (bit mask)
.var GS_MISCIO_TCHFLX_ADDR = $D6B0  // Flip Y axis of touch interface if set (address)
.var GS_MISCIO_TCHFLX_MASK = 128  // Flip Y axis of touch interface if set (bit mask)
.var TOUCH_YINV_ADDR = $D6B0  // Invert vertical axis (address)
.var YINV_ADDR = $D6B0  // Invert vertical axis (address)
.var TOUCH_YINV_MASK = 128  // Invert vertical axis (bit mask)
.var YINV_MASK = 128  // Invert vertical axis (bit mask)
...
.var TOUCH_TOUCH1XMSB_MASK = 3  // Touch pad touch \#1 X MSBs (bit mask)
.var TOUCH1XMSB_MASK = 3  // Touch pad touch \#1 X MSBs (bit mask)
.var TOUCH_TOUCH1YMSB_ADDR = $D6BB  // Touch pad touch \#1 Y MSBs (address)
.var TOUCH1YMSB_ADDR = $D6BB  // Touch pad touch \#1 Y MSBs (address)
.var TOUCH_TOUCH1YMSB_MASK = 48  // Touch pad touch \#1 Y MSBs (bit mask)
.var TOUCH1YMSB_MASK = 48  // Touch pad touch \#1 Y MSBs (bit mask)
...
.var TOUCH_TOUCH2XMSB_MASK = 3  // Touch pad touch \#2 X MSBs (bit mask)
.var TOUCH2XMSB_MASK = 3  // Touch pad touch \#2 X MSBs (bit mask)
.var TOUCH_TOUCH2YMSB_ADDR = $D6BE  // Touch pad touch \#2 Y MSBs (address)
.var TOUCH2YMSB_ADDR = $D6BE  // Touch pad touch \#2 Y MSBs (address)
.var TOUCH_TOUCH2YMSB_MASK = 48  // Touch pad touch \#2 Y MSBs (bit mask)
.var TOUCH2YMSB_MASK = 48  // Touch pad touch \#2 Y MSBs (bit mask)
...
.var MISCIO_TCHBYTENUM_MASK = 127  // Select byte number for touch panel communications instrumentation (bit mask)
.var TCHBYTENUM_MASK = 127  // Select byte number for touch panel communications instrumentation (bit mask)
...
.var MISCIO_TCHI2CEN_MASK = 128  // Enable/disable touch panel I2C communications (bit mask)
.var TCHI2CEN_MASK = 128  // Enable/disable touch panel I2C communications (bit mask)
...
.var TOUCH_GESTUREDIR_MASK = 15  // Touch pad gesture directions (left,right,up,down) (bit mask)
.var GESTUREDIR_MASK = 15  // Touch pad gesture directions (left,right,up,down) (bit mask)
.var TOUCH_GESTUREID_ADDR = $D6C0  // Touch pad gesture ID (address)
.var GESTUREID_ADDR = $D6C0  // Touch pad gesture ID (address)
.var TOUCH_GESTUREID_MASK = 240  // Touch pad gesture ID (bit mask)
.var GESTUREID_MASK = 240  // Touch pad gesture ID (bit mask)
...
.var QSPI_DB_MASK = 15  // Data bits for QSPI flash interface (read/write) (bit mask)
.var DB_MASK = 15  // Data bits for QSPI flash interface (read/write) (bit mask)
.var QSPI_RESERVED_ADDR = $D6CC  // (set to 0) (address)
.var QSPI_RESERVED_MASK = 16  // (set to 0) (bit mask)
.var QSPI_CLOCK_ADDR = $D6CC  // Clock output line for QSPI flash (address)
.var QSPI_CLOCK_MASK = 32  // Clock output line for QSPI flash (bit mask)
...
.var QSPI_CSN_MASK = 64  // Active-low chip-select for QSPI flash (bit mask)
.var CSN_MASK = 64  // Active-low chip-select for QSPI flash (bit mask)
.var QSPI_TRI_ADDR = $D6CC  // Tristate DB0-3 (address)
.var TRI_ADDR = $D6CC  // Tristate DB0-3 (address)
.var QSPI_TRI_MASK = 128  // Tristate DB0-3 (bit mask)
.var TRI_MASK = 128  // Tristate DB0-3 (bit mask)
...
.var QSPI_CLOCKRUN_MASK = 1  // Set to cause QSPI clock to free run at CPU clock frequency. (bit mask)
.var CLOCKRUN_MASK = 1  // Set to cause QSPI clock to free run at CPU clock frequency. (bit mask)
...
.var MISCIO_I2CRST_MASK = 1  // I2C reset (bit mask)
.var I2CRST_MASK = 1  // I2C reset (bit mask)
...
.var MISCIO_I2CL_MASK = 2  // I2C command latch write strobe (write 1 to trigger command) (bit mask)
.var I2CL_MASK = 2  // I2C command latch write strobe (write 1 to trigger command) (bit mask)
.var MISCIO_I2CRW_ADDR = $D6D1  // I2C Select read (1) or write (0) (address)
.var I2CRW_ADDR = $D6D1  // I2C Select read (1) or write (0) (address)
.var MISCIO_I2CRW_MASK = 4  // I2C Select read (1) or write (0) (bit mask)
.var I2CRW_MASK = 4  // I2C Select read (1) or write (0) (bit mask)
.var MISCIO_I2CSW_ADDR = $D6D1  // I2C bus 1 swap SDA/SCL pins (address)
.var I2CSW_ADDR = $D6D1  // I2C bus 1 swap SDA/SCL pins (address)
.var MISCIO_I2CSW_MASK = 32  // I2C bus 1 swap SDA/SCL pins (bit mask)
.var I2CSW_MASK = 32  // I2C bus 1 swap SDA/SCL pins (bit mask)
.var MISCIO_I2CBSY_ADDR = $D6D1  // I2C busy flag (address)
.var I2CBSY_ADDR = $D6D1  // I2C busy flag (address)
.var MISCIO_I2CBSY_MASK = 64  // I2C busy flag (bit mask)
.var I2CBSY_MASK = 64  // I2C busy flag (bit mask)
.var MISCIO_I2CERR_ADDR = $D6D1  // I2C ack error (address)
.var I2CERR_ADDR = $D6D1  // I2C ack error (address)
.var MISCIO_I2CERR_MASK = 128  // I2C ack error (bit mask)
.var I2CERR_MASK = 128  // I2C ack error (bit mask)
.var MISCIO_I2CADDR_ADDR = $D6D2  // I2C address (address)
.var I2CADDR_ADDR = $D6D2  // I2C address (address)
.var MISCIO_I2CADDR_MASK = 254  // I2C address (bit mask)
.var I2CADDR_MASK = 254  // I2C address (bit mask)
...
.var ETH_RST_MASK = 1  // Write 0 to hold ethernet controller under reset (bit mask)
...
.var ETH_TXRST_MASK = 2  // Write 0 to hold ethernet controller transmit sub-system under reset (bit mask)
.var TXRST_MASK = 2  // Write 0 to hold ethernet controller transmit sub-system under reset (bit mask)
...
.var ETH_DRXD_MASK = 4  // Read ethernet RX bits currently on the wire (bit mask)
.var DRXD_MASK = 4  // Read ethernet RX bits currently on the wire (bit mask)
...
.var ETH_DRXDV_MASK = 8  // Read ethernet RX data valid (debug) (bit mask)
.var DRXDV_MASK = 8  // Read ethernet RX data valid (debug) (bit mask)
...
.var ETH_KEYEN_MASK = 16  // Allow remote keyboard input via magic ethernet frames (bit mask)
.var KEYEN_MASK = 16  // Allow remote keyboard input via magic ethernet frames (bit mask)
...
.var ETH_RXBLKD_MASK = 64  // Indicate if ethernet RX is blocked until RX buffers freed (bit mask)
.var RXBLKD_MASK = 64  // Indicate if ethernet RX is blocked until RX buffers freed (bit mask)
...
.var ETH_TXIDLE_MASK = 128  // Ethernet transmit side is idle, i.e., a packet can be sent. (bit mask)
.var TXIDLE_MASK = 128  // Ethernet transmit side is idle, i.e., a packet can be sent. (bit mask)
.var ETH_RXBF_ADDR = $D6E1  // Number of free receive buffers (address)
.var RXBF_ADDR = $D6E1  // Number of free receive buffers (address)
.var ETH_RXBF_MASK = 6  // Number of free receive buffers (bit mask)
.var RXBF_MASK = 6  // Number of free receive buffers (bit mask)
...
.var ETH_STRM_MASK = 8  // Enable streaming of CPU instruction stream or VIC-IV display on ethernet (bit mask)
.var STRM_MASK = 8  // Enable streaming of CPU instruction stream or VIC-IV display on ethernet (bit mask)
.var ETH_TXQ_ADDR = $D6E1  // Ethernet TX IRQ status (address)
.var TXQ_ADDR = $D6E1  // Ethernet TX IRQ status (address)
.var ETH_TXQ_MASK = 16  // Ethernet TX IRQ status (bit mask)
.var TXQ_MASK = 16  // Ethernet TX IRQ status (bit mask)
.var ETH_RXQ_ADDR = $D6E1  // Ethernet RX IRQ status (address)
.var RXQ_ADDR = $D6E1  // Ethernet RX IRQ status (address)
.var ETH_RXQ_MASK = 32  // Ethernet RX IRQ status (bit mask)
.var RXQ_MASK = 32  // Ethernet RX IRQ status (bit mask)
.var ETH_TXQEN_ADDR = $D6E1  // Enable ethernet TX IRQ (address)
.var TXQEN_ADDR = $D6E1  // Enable ethernet TX IRQ (address)
.var ETH_TXQEN_MASK = 64  // Enable ethernet TX IRQ (bit mask)
.var TXQEN_MASK = 64  // Enable ethernet TX IRQ (bit mask)
.var ETH_RXQEN_ADDR = $D6E1  // Enable ethernet RX IRQ (address)
.var RXQEN_ADDR = $D6E1  // Enable ethernet RX IRQ (address)
.var ETH_RXQEN_MASK = 128  // Enable ethernet RX IRQ (bit mask)
.var RXQEN_MASK = 128  // Enable ethernet RX IRQ (bit mask)
...
.var ETH_NOPROM_MASK = 1  // Ethernet disable promiscuous mode (bit mask)
.var NOPROM_MASK = 1  // Ethernet disable promiscuous mode (bit mask)
...
.var ETH_NOCRC_MASK = 2  // Disable CRC check for received packets (bit mask)
.var NOCRC_MASK = 2  // Disable CRC check for received packets (bit mask)
.var ETH_TXPH_ADDR = $D6E5  // Ethernet TX clock phase adjust (address)
.var TXPH_ADDR = $D6E5  // Ethernet TX clock phase adjust (address)
.var ETH_TXPH_MASK = 12  // Ethernet TX clock phase adjust (bit mask)
.var TXPH_MASK = 12  // Ethernet TX clock phase adjust (bit mask)
.var ETH_BCST_ADDR = $D6E5  // Accept broadcast frames (address)
.var BCST_ADDR = $D6E5  // Accept broadcast frames (address)
.var ETH_BCST_MASK = 16  // Accept broadcast frames (bit mask)
.var BCST_MASK = 16  // Accept broadcast frames (bit mask)
.var ETH_MCST_ADDR = $D6E5  // Accept multicast frames (address)
.var MCST_ADDR = $D6E5  // Accept multicast frames (address)
.var ETH_MCST_MASK = 32  // Accept multicast frames (bit mask)
.var MCST_MASK = 32  // Accept multicast frames (bit mask)
.var ETH_RXPH_ADDR = $D6E5  // Ethernet RX clock phase adjust (address)
.var RXPH_ADDR = $D6E5  // Ethernet RX clock phase adjust (address)
.var ETH_RXPH_MASK = 192  // Ethernet RX clock phase adjust (bit mask)
.var RXPH_MASK = 192  // Ethernet RX clock phase adjust (bit mask)
...
.var ETH_MIIMREG_MASK = 31  // Ethernet MIIM register number (bit mask)
.var MIIMREG_MASK = 31  // Ethernet MIIM register number (bit mask)
...
.var ETH_MIIMPHY_MASK = 224  // Ethernet MIIM PHY number (use 0 for Nexys4, 1 for MEGA65 r1 PCBs) (bit mask)
.var MIIMPHY_MASK = 224  // Ethernet MIIM PHY number (use 0 for Nexys4, 1 for MEGA65 r1 PCBs) (bit mask)
...
.var DMA_EN018B_MASK = 1  // DMA enable F018B mode (adds sub-command byte) (bit mask)
.var EN018B_MASK = 1  // DMA enable F018B mode (adds sub-command byte) (bit mask)
...
.var MATH_MULBUSY_MASK = 64  // Set if hardware multiplier is busy (bit mask)
.var MULBUSY_MASK = 64  // Set if hardware multiplier is busy (bit mask)
...
.var MATH_DIVBUSY_MASK = 128  // Set if hardware divider is busy (bit mask)
.var DIVBUSY_MASK = 128  // Set if hardware divider is busy (bit mask)
.var CPU_BADLEN_ADDR = $D710  // Enable badline emulation (address)
.var BADLEN_ADDR = $D710  // Enable badline emulation (address)
.var CPU_BADLEN_MASK = 1  // Enable badline emulation (bit mask)
.var BADLEN_MASK = 1  // Enable badline emulation (bit mask)
...
.var BRCOST_MASK = 8  // 1=charge extra cycle(s) for branches taken (bit mask)
...
.var CPU_BADEXTRA_MASK = 48  // Cost of badlines minus 40. ie. 00=40 cycles, 11 = 43 cycles. (bit mask)
.var BADEXTRA_MASK = 48  // Cost of badlines minus 40. ie. 00=40 cycles, 11 = 43 cycles. (bit mask)
...
.var NOMIX_MASK = 16  // Audio DMA bypasses audio mixer (bit mask)
...
.var DMA_AUD_WRBLK_MASK = 32  // Audio DMA block writes (samples still get read) (bit mask)
.var AUD_WRBLK_MASK = 32  // Audio DMA block writes (samples still get read) (bit mask)
...
.var DMA_BLKD_MASK = 64  // Audio DMA blocked (read only) DEBUG (bit mask)
.var BLKD_MASK = 64  // Audio DMA blocked (read only) DEBUG (bit mask)
.var DMA_AUDEN_ADDR = $D711  // Enable Audio DMA (address)
.var AUDEN_ADDR = $D711  // Enable Audio DMA (address)
.var DMA_AUDEN_MASK = 128  // Enable Audio DMA (bit mask)
.var AUDEN_MASK = 128  // Enable Audio DMA (bit mask)
...
.var DMA_CH0_SBITS_MASK = 3  // Audio DMA channel X sample bits (11=16, 10=8, 01=upper nybl, 00=lower nybl) (bit mask)
.var CH0_SBITS_MASK = 3  // Audio DMA channel X sample bits (11=16, 10=8, 01=upper nybl, 00=lower nybl) (bit mask)
...
.var DMA_CH0_STP_MASK = 8  // Audio DMA channel X stop flag (bit mask)
.var CH0_STP_MASK = 8  // Audio DMA channel X stop flag (bit mask)
...
.var DMA_CH0_SINE_MASK = 16  // Audio DMA channel X play 32-sample sine wave instead of DMA data (bit mask)
.var CH0_SINE_MASK = 16  // Audio DMA channel X play 32-sample sine wave instead of DMA data (bit mask)
...
.var DMA_CH0_SGN_MASK = 32  // Enable Audio DMA channel X signed samples (bit mask)
.var CH0_SGN_MASK = 32  // Enable Audio DMA channel X signed samples (bit mask)
...
.var DMA_CH0_LOOP_MASK = 64  // Enable Audio DMA channel X looping (bit mask)
.var CH0_LOOP_MASK = 64  // Enable Audio DMA channel X looping (bit mask)
.var DMA_CH0_EN_ADDR = $D720  // Enable Audio DMA channel X (address)
.var CH0_EN_ADDR = $D720  // Enable Audio DMA channel X (address)
.var DMA_CH0_EN_MASK = 128  // Enable Audio DMA channel X (bit mask)
.var CH0_EN_MASK = 128  // Enable Audio DMA channel X (bit mask)
...
.var DMA_CH1_SBITS_MASK = 3  // @CHXSBITS (bit mask)
.var CH1_SBITS_MASK = 3  // @CHXSBITS (bit mask)
.var DMA_CH1_STP_ADDR = $D730  // @CHXSTP (address)
.var CH1_STP_ADDR = $D730  // @CHXSTP (address)
.var DMA_CH1_STP_MASK = 8  // @CHXSTP (bit mask)
.var CH1_STP_MASK = 8  // @CHXSTP (bit mask)
.var DMA_CH1_SINE_ADDR = $D730  // @CHXSINE (address)
.var CH1_SINE_ADDR = $D730  // @CHXSINE (address)
.var DMA_CH1_SINE_MASK = 16  // @CHXSINE (bit mask)
.var CH1_SINE_MASK = 16  // @CHXSINE (bit mask)
.var DMA_CH1_SGN_ADDR = $D730  // @CHXSGN (address)
.var CH1_SGN_ADDR = $D730  // @CHXSGN (address)
.var DMA_CH1_SGN_MASK = 32  // @CHXSGN (bit mask)
.var CH1_SGN_MASK = 32  // @CHXSGN (bit mask)
.var DMA_CH1_LOOP_ADDR = $D730  // @CHXLOOP (address)
.var CH1_LOOP_ADDR = $D730  // @CHXLOOP (address)
.var DMA_CH1_LOOP_MASK = 64  // @CHXLOOP (bit mask)
.var CH1_LOOP_MASK = 64  // @CHXLOOP (bit mask)
.var DMA_CH1_EN_ADDR = $D730  // @CHXEN (address)
.var CH1_EN_ADDR = $D730  // @CHXEN (address)
.var DMA_CH1_EN_MASK = 128  // @CHXEN (bit mask)
.var CH1_EN_MASK = 128  // @CHXEN (bit mask)
...
.var DMA_CH2_SBITS_MASK = 3  // @CHXSBITS (bit mask)
.var CH2_SBITS_MASK = 3  // @CHXSBITS (bit mask)
.var DMA_CH2_STP_ADDR = $D740  // @CHXSTP (address)
.var CH2_STP_ADDR = $D740  // @CHXSTP (address)
.var DMA_CH2_STP_MASK = 8  // @CHXSTP (bit mask)
.var CH2_STP_MASK = 8  // @CHXSTP (bit mask)
.var DMA_CH2_SINE_ADDR = $D740  // @CHXSINE (address)
.var CH2_SINE_ADDR = $D740  // @CHXSINE (address)
.var DMA_CH2_SINE_MASK = 16  // @CHXSINE (bit mask)
.var CH2_SINE_MASK = 16  // @CHXSINE (bit mask)
.var DMA_CH2_SGN_ADDR = $D740  // @CHXSGN (address)
.var CH2_SGN_ADDR = $D740  // @CHXSGN (address)
.var DMA_CH2_SGN_MASK = 32  // @CHXSGN (bit mask)
.var CH2_SGN_MASK = 32  // @CHXSGN (bit mask)
.var DMA_CH2_LOOP_ADDR = $D740  // @CHXLOOP (address)
.var CH2_LOOP_ADDR = $D740  // @CHXLOOP (address)
.var DMA_CH2_LOOP_MASK = 64  // @CHXLOOP (bit mask)
.var CH2_LOOP_MASK = 64  // @CHXLOOP (bit mask)
.var DMA_CH2_EN_ADDR = $D740  // @CHXEN (address)
.var CH2_EN_ADDR = $D740  // @CHXEN (address)
.var DMA_CH2_EN_MASK = 128  // @CHXEN (bit mask)
.var CH2_EN_MASK = 128  // @CHXEN (bit mask)
...
.var DMA_CH3_SBITS_MASK = 3  // @CHXSBITS (bit mask)
.var CH3_SBITS_MASK = 3  // @CHXSBITS (bit mask)
.var DMA_CH3_STP_ADDR = $D750  // @CHXSTP (address)
.var CH3_STP_ADDR = $D750  // @CHXSTP (address)
.var DMA_CH3_STP_MASK = 8  // @CHXSTP (bit mask)
.var CH3_STP_MASK = 8  // @CHXSTP (bit mask)
.var DMA_CH3_SINE_ADDR = $D750  // @CHXSINE (address)
.var CH3_SINE_ADDR = $D750  // @CHXSINE (address)
.var DMA_CH3_SINE_MASK = 16  // @CHXSINE (bit mask)
.var CH3_SINE_MASK = 16  // @CHXSINE (bit mask)
.var DMA_CH3_SGN_ADDR = $D750  // @CHXSGN (address)
.var CH3_SGN_ADDR = $D750  // @CHXSGN (address)
.var DMA_CH3_SGN_MASK = 32  // @CHXSGN (bit mask)
.var CH3_SGN_MASK = 32  // @CHXSGN (bit mask)
.var DMA_CH3_LOOP_ADDR = $D750  // @CHXLOOP (address)
.var CH3_LOOP_ADDR = $D750  // @CHXLOOP (address)
.var DMA_CH3_LOOP_MASK = 64  // @CHXLOOP (bit mask)
.var CH3_LOOP_MASK = 64  // @CHXLOOP (bit mask)
.var DMA_CH3_EN_ADDR = $D750  // @CHXEN (address)
.var CH3_EN_ADDR = $D750  // @CHXEN (address)
.var DMA_CH3_EN_MASK = 128  // @CHXEN (bit mask)
.var CH3_EN_MASK = 128  // @CHXEN (bit mask)
...
.var MATH_UNIT0INA_MASK = 15  // Select which of the 16 32-bit math registers is input A for Math Function Unit X. (bit mask)
.var UNIT0INA_MASK = 15  // Select which of the 16 32-bit math registers is input A for Math Function Unit X. (bit mask)
...
.var MATH_UNIT0INB_MASK = 240  // Select which of the 16 32-bit math registers is input B for Math Function Unit X. (bit mask)
.var UNIT0INB_MASK = 240  // Select which of the 16 32-bit math registers is input B for Math Function Unit X. (bit mask)
.var MATH_UNIT1INA_ADDR = $D7C1  // @UNITXINA (address)
.var UNIT1INA_ADDR = $D7C1  // @UNITXINA (address)
.var MATH_UNIT1INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT1INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT1INB_ADDR = $D7C1  // @UNITXINB (address)
.var UNIT1INB_ADDR = $D7C1  // @UNITXINB (address)
.var MATH_UNIT1INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT1INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNIT2INA_ADDR = $D7C2  // @UNITXINA (address)
.var UNIT2INA_ADDR = $D7C2  // @UNITXINA (address)
.var MATH_UNIT2INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT2INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT2INB_ADDR = $D7C2  // @UNITXINB (address)
.var UNIT2INB_ADDR = $D7C2  // @UNITXINB (address)
.var MATH_UNIT2INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT2INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNIT3INA_ADDR = $D7C3  // @UNITXINA (address)
.var UNIT3INA_ADDR = $D7C3  // @UNITXINA (address)
.var MATH_UNIT3INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT3INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT3INB_ADDR = $D7C3  // @UNITXINB (address)
.var UNIT3INB_ADDR = $D7C3  // @UNITXINB (address)
.var MATH_UNIT3INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT3INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNIT4INA_ADDR = $D7C4  // @UNITXINA (address)
.var UNIT4INA_ADDR = $D7C4  // @UNITXINA (address)
.var MATH_UNIT4INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT4INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT4INB_ADDR = $D7C4  // @UNITXINB (address)
.var UNIT4INB_ADDR = $D7C4  // @UNITXINB (address)
.var MATH_UNIT4INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT4INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNIT5INA_ADDR = $D7C5  // @UNITXINA (address)
.var UNIT5INA_ADDR = $D7C5  // @UNITXINA (address)
.var MATH_UNIT5INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT5INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT5INB_ADDR = $D7C5  // @UNITXINB (address)
.var UNIT5INB_ADDR = $D7C5  // @UNITXINB (address)
.var MATH_UNIT5INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT5INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNIT6INA_ADDR = $D7C6  // @UNITXINA (address)
.var UNIT6INA_ADDR = $D7C6  // @UNITXINA (address)
.var MATH_UNIT6INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT6INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT6INB_ADDR = $D7C6  // @UNITXINB (address)
.var UNIT6INB_ADDR = $D7C6  // @UNITXINB (address)
.var MATH_UNIT6INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT6INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNIT7INA_ADDR = $D7C7  // @UNITXINA (address)
.var UNIT7INA_ADDR = $D7C7  // @UNITXINA (address)
.var MATH_UNIT7INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT7INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT7INB_ADDR = $D7C7  // @UNITXINB (address)
.var UNIT7INB_ADDR = $D7C7  // @UNITXINB (address)
.var MATH_UNIT7INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT7INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNIT8INA_ADDR = $D7C8  // @UNITXINA (address)
.var UNIT8INA_ADDR = $D7C8  // @UNITXINA (address)
.var MATH_UNIT8INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT8INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT8INB_ADDR = $D7C8  // @UNITXINB (address)
.var UNIT8INB_ADDR = $D7C8  // @UNITXINB (address)
.var MATH_UNIT8INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT8INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNIT9INA_ADDR = $D7C9  // @UNITXINA (address)
.var UNIT9INA_ADDR = $D7C9  // @UNITXINA (address)
.var MATH_UNIT9INA_MASK = 15  // @UNITXINA (bit mask)
.var UNIT9INA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNIT9INB_ADDR = $D7C9  // @UNITXINB (address)
.var UNIT9INB_ADDR = $D7C9  // @UNITXINB (address)
.var MATH_UNIT9INB_MASK = 240  // @UNITXINB (bit mask)
.var UNIT9INB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNITAINA_ADDR = $D7CA  // @UNITXINA (address)
.var UNITAINA_ADDR = $D7CA  // @UNITXINA (address)
.var MATH_UNITAINA_MASK = 15  // @UNITXINA (bit mask)
.var UNITAINA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNITAINB_ADDR = $D7CA  // @UNITXINB (address)
.var UNITAINB_ADDR = $D7CA  // @UNITXINB (address)
.var MATH_UNITAINB_MASK = 240  // @UNITXINB (bit mask)
.var UNITAINB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNITBINA_ADDR = $D7CB  // @UNITXINA (address)
.var UNITBINA_ADDR = $D7CB  // @UNITXINA (address)
.var MATH_UNITBINA_MASK = 15  // @UNITXINA (bit mask)
.var UNITBINA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNITBINB_ADDR = $D7CB  // @UNITXINB (address)
.var UNITBINB_ADDR = $D7CB  // @UNITXINB (address)
.var MATH_UNITBINB_MASK = 240  // @UNITXINB (bit mask)
.var UNITBINB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNITCINA_ADDR = $D7CC  // @UNITXINA (address)
.var UNITCINA_ADDR = $D7CC  // @UNITXINA (address)
.var MATH_UNITCINA_MASK = 15  // @UNITXINA (bit mask)
.var UNITCINA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNITCINB_ADDR = $D7CC  // @UNITXINB (address)
.var UNITCINB_ADDR = $D7CC  // @UNITXINB (address)
.var MATH_UNITCINB_MASK = 240  // @UNITXINB (bit mask)
.var UNITCINB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNITDINA_ADDR = $D7CD  // @UNITXINA (address)
.var UNITDINA_ADDR = $D7CD  // @UNITXINA (address)
.var MATH_UNITDINA_MASK = 15  // @UNITXINA (bit mask)
.var UNITDINA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNITDINB_ADDR = $D7CD  // @UNITXINB (address)
.var UNITDINB_ADDR = $D7CD  // @UNITXINB (address)
.var MATH_UNITDINB_MASK = 240  // @UNITXINB (bit mask)
.var UNITDINB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNITEINA_ADDR = $D7CE  // @UNITXINA (address)
.var UNITEINA_ADDR = $D7CE  // @UNITXINA (address)
.var MATH_UNITEINA_MASK = 15  // @UNITXINA (bit mask)
.var UNITEINA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNITEINB_ADDR = $D7CE  // @UNITXINB (address)
.var UNITEINB_ADDR = $D7CE  // @UNITXINB (address)
.var MATH_UNITEINB_MASK = 240  // @UNITXINB (bit mask)
.var UNITEINB_MASK = 240  // @UNITXINB (bit mask)
.var MATH_UNITFINA_ADDR = $D7CF  // @UNITXINA (address)
.var UNITFINA_ADDR = $D7CF  // @UNITXINA (address)
.var MATH_UNITFINA_MASK = 15  // @UNITXINA (bit mask)
.var UNITFINA_MASK = 15  // @UNITXINA (bit mask)
.var MATH_UNITFINB_ADDR = $D7CF  // @UNITXINB (address)
.var UNITFINB_ADDR = $D7CF  // @UNITXINB (address)
.var MATH_UNITFINB_MASK = 240  // @UNITXINB (bit mask)
.var UNITFINB_MASK = 240  // @UNITXINB (bit mask)
...
.var MATH_UNIT0OUT_MASK = 15  // Select which of the 16 32-bit math registers receives the output of Math Function Unit X (bit mask)
.var UNIT0OUT_MASK = 15  // Select which of the 16 32-bit math registers receives the output of Math Function Unit X (bit mask)
...
.var MATH_U0_LOWOUT_MASK = 16  // If set, the low-half of the output of Math Function Unit X is written to math register UNITXOUT. (bit mask)
.var U0_LOWOUT_MASK = 16  // If set, the low-half of the output of Math Function Unit X is written to math register UNITXOUT. (bit mask)
...
.var MATH_U0_HIOUT_MASK = 32  // If set, the high-half of the output of Math Function Unit X is written to math register UNITXOUT. (bit mask)
.var U0_HIOUT_MASK = 32  // If set, the high-half of the output of Math Function Unit X is written to math register UNITXOUT. (bit mask)
...
.var MATH_U0_MLADD_MASK = 64  // If set, Math Function Unit X acts as a 32-bit adder instead of 32-bit multiplier. (bit mask)
.var U0_MLADD_MASK = 64  // If set, Math Function Unit X acts as a 32-bit adder instead of 32-bit multiplier. (bit mask)
...
.var MATH_U0_LATCH_MASK = 128  // If set, Math Function Unit X's output is latched. (bit mask)
.var U0_LATCH_MASK = 128  // If set, Math Function Unit X's output is latched. (bit mask)
.var MATH_UNIT1OUT_ADDR = $D7D1  // @UNITXOUT (address)
.var UNIT1OUT_ADDR = $D7D1  // @UNITXOUT (address)
.var MATH_UNIT1OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT1OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U1_LOWOUT_ADDR = $D7D1  // @UXLOWOUT (address)
.var U1_LOWOUT_ADDR = $D7D1  // @UXLOWOUT (address)
.var MATH_U1_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U1_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U1_HIOUT_ADDR = $D7D1  // @UXHIOUT (address)
.var U1_HIOUT_ADDR = $D7D1  // @UXHIOUT (address)
.var MATH_U1_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U1_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_U1_MLADD_ADDR = $D7D1  // @UXMLADD (address)
.var U1_MLADD_ADDR = $D7D1  // @UXMLADD (address)
.var MATH_U1_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var U1_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var MATH_U1_LATCH_ADDR = $D7D1  // @UXLATCH (address)
.var U1_LATCH_ADDR = $D7D1  // @UXLATCH (address)
.var MATH_U1_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U1_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNIT2OUT_ADDR = $D7D2  // @UNITXOUT (address)
.var UNIT2OUT_ADDR = $D7D2  // @UNITXOUT (address)
.var MATH_UNIT2OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT2OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U2_LOWOUT_ADDR = $D7D2  // @UXLOWOUT (address)
.var U2_LOWOUT_ADDR = $D7D2  // @UXLOWOUT (address)
.var MATH_U2_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U2_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U2_HIOUT_ADDR = $D7D2  // @UXHIOUT (address)
.var U2_HIOUT_ADDR = $D7D2  // @UXHIOUT (address)
.var MATH_U2_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U2_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_U2_MLADD_ADDR = $D7D2  // @UXMLADD (address)
.var U2_MLADD_ADDR = $D7D2  // @UXMLADD (address)
.var MATH_U2_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var U2_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var MATH_U2_LATCH_ADDR = $D7D2  // @UXLATCH (address)
.var U2_LATCH_ADDR = $D7D2  // @UXLATCH (address)
.var MATH_U2_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U2_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNIT3OUT_ADDR = $D7D3  // @UNITXOUT (address)
.var UNIT3OUT_ADDR = $D7D3  // @UNITXOUT (address)
.var MATH_UNIT3OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT3OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U3_LOWOUT_ADDR = $D7D3  // @UXLOWOUT (address)
.var U3_LOWOUT_ADDR = $D7D3  // @UXLOWOUT (address)
.var MATH_U3_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U3_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U3_HIOUT_ADDR = $D7D3  // @UXHIOUT (address)
.var U3_HIOUT_ADDR = $D7D3  // @UXHIOUT (address)
.var MATH_U3_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U3_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_U3_MLADD_ADDR = $D7D3  // @UXMLADD (address)
.var U3_MLADD_ADDR = $D7D3  // @UXMLADD (address)
.var MATH_U3_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var U3_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var MATH_U3_LATCH_ADDR = $D7D3  // @UXLATCH (address)
.var U3_LATCH_ADDR = $D7D3  // @UXLATCH (address)
.var MATH_U3_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U3_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNIT4OUT_ADDR = $D7D4  // @UNITXOUT (address)
.var UNIT4OUT_ADDR = $D7D4  // @UNITXOUT (address)
.var MATH_UNIT4OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT4OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U4_LOWOUT_ADDR = $D7D4  // @UXLOWOUT (address)
.var U4_LOWOUT_ADDR = $D7D4  // @UXLOWOUT (address)
.var MATH_U4_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U4_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U4_HIOUT_ADDR = $D7D4  // @UXHIOUT (address)
.var U4_HIOUT_ADDR = $D7D4  // @UXHIOUT (address)
.var MATH_U4_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U4_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_U4_MLADD_ADDR = $D7D4  // @UXMLADD (address)
.var U4_MLADD_ADDR = $D7D4  // @UXMLADD (address)
.var MATH_U4_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var U4_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var MATH_U4_LATCH_ADDR = $D7D4  // @UXLATCH (address)
.var U4_LATCH_ADDR = $D7D4  // @UXLATCH (address)
.var MATH_U4_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U4_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNIT5OUT_ADDR = $D7D5  // @UNITXOUT (address)
.var UNIT5OUT_ADDR = $D7D5  // @UNITXOUT (address)
.var MATH_UNIT5OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT5OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U5_LOWOUT_ADDR = $D7D5  // @UXLOWOUT (address)
.var U5_LOWOUT_ADDR = $D7D5  // @UXLOWOUT (address)
.var MATH_U5_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U5_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U5_HIOUT_ADDR = $D7D5  // @UXHIOUT (address)
.var U5_HIOUT_ADDR = $D7D5  // @UXHIOUT (address)
.var MATH_U5_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U5_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_U5_MLADD_ADDR = $D7D5  // @UXMLADD (address)
.var U5_MLADD_ADDR = $D7D5  // @UXMLADD (address)
.var MATH_U5_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var U5_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var MATH_U5_LATCH_ADDR = $D7D5  // @UXLATCH (address)
.var U5_LATCH_ADDR = $D7D5  // @UXLATCH (address)
.var MATH_U5_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U5_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNIT6OUT_ADDR = $D7D6  // @UNITXOUT (address)
.var UNIT6OUT_ADDR = $D7D6  // @UNITXOUT (address)
.var MATH_UNIT6OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT6OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U6_LOWOUT_ADDR = $D7D6  // @UXLOWOUT (address)
.var U6_LOWOUT_ADDR = $D7D6  // @UXLOWOUT (address)
.var MATH_U6_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U6_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U6_HIOUT_ADDR = $D7D6  // @UXHIOUT (address)
.var U6_HIOUT_ADDR = $D7D6  // @UXHIOUT (address)
.var MATH_U6_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U6_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_U6_MLADD_ADDR = $D7D6  // @UXMLADD (address)
.var U6_MLADD_ADDR = $D7D6  // @UXMLADD (address)
.var MATH_U6_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var U6_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var MATH_U6_LATCH_ADDR = $D7D6  // @UXLATCH (address)
.var U6_LATCH_ADDR = $D7D6  // @UXLATCH (address)
.var MATH_U6_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U6_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNIT7OUT_ADDR = $D7D7  // @UNITXOUT (address)
.var UNIT7OUT_ADDR = $D7D7  // @UNITXOUT (address)
.var MATH_UNIT7OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT7OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U7_LOWOUT_ADDR = $D7D7  // @UXLOWOUT (address)
.var U7_LOWOUT_ADDR = $D7D7  // @UXLOWOUT (address)
.var MATH_U7_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U7_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U7_HIOUT_ADDR = $D7D7  // @UXHIOUT (address)
.var U7_HIOUT_ADDR = $D7D7  // @UXHIOUT (address)
.var MATH_U7_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U7_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_U7_MLADD_ADDR = $D7D7  // @UXMLADD (address)
.var U7_MLADD_ADDR = $D7D7  // @UXMLADD (address)
.var MATH_U7_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var U7_MLADD_MASK = 64  // @UXMLADD (bit mask)
.var MATH_U7_LATCH_ADDR = $D7D7  // @UXLATCH (address)
.var U7_LATCH_ADDR = $D7D7  // @UXLATCH (address)
.var MATH_U7_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U7_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNIT8OUT_ADDR = $D7D8  // @UNITXOUT (address)
.var UNIT8OUT_ADDR = $D7D8  // @UNITXOUT (address)
.var MATH_UNIT8OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT8OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U8_LOWOUT_ADDR = $D7D8  // @UXLOWOUT (address)
.var U8_LOWOUT_ADDR = $D7D8  // @UXLOWOUT (address)
.var MATH_U8_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U8_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U8_HIOUT_ADDR = $D7D8  // @UXHIOUT (address)
.var U8_HIOUT_ADDR = $D7D8  // @UXHIOUT (address)
.var MATH_U8_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U8_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
...
.var MATH_U8_BSADD_MASK = 64  // If set, Math Function Unit Y acts as a 32-bit adder instead of 32-bit barrel-shifter. (bit mask)
.var U8_BSADD_MASK = 64  // If set, Math Function Unit Y acts as a 32-bit adder instead of 32-bit barrel-shifter. (bit mask)
.var MATH_U8_LATCH_ADDR = $D7D8  // @UXLATCH (address)
.var U8_LATCH_ADDR = $D7D8  // @UXLATCH (address)
.var MATH_U8_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U8_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNIT9OUT_ADDR = $D7D9  // @UNITXOUT (address)
.var UNIT9OUT_ADDR = $D7D9  // @UNITXOUT (address)
.var MATH_UNIT9OUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNIT9OUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_U9_LOWOUT_ADDR = $D7D9  // @UXLOWOUT (address)
.var U9_LOWOUT_ADDR = $D7D9  // @UXLOWOUT (address)
.var MATH_U9_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var U9_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_U9_HIOUT_ADDR = $D7D9  // @UXHIOUT (address)
.var U9_HIOUT_ADDR = $D7D9  // @UXHIOUT (address)
.var MATH_U9_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var U9_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_U9_BSADD_ADDR = $D7D9  // @UXBSADD (address)
.var U9_BSADD_ADDR = $D7D9  // @UXBSADD (address)
.var MATH_U9_BSADD_MASK = 64  // @UXBSADD (bit mask)
.var U9_BSADD_MASK = 64  // @UXBSADD (bit mask)
.var MATH_U9_LATCH_ADDR = $D7D9  // @UXLATCH (address)
.var U9_LATCH_ADDR = $D7D9  // @UXLATCH (address)
.var MATH_U9_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var U9_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNITAOUT_ADDR = $D7DA  // @UNITXOUT (address)
.var UNITAOUT_ADDR = $D7DA  // @UNITXOUT (address)
.var MATH_UNITAOUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNITAOUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_UA_LOWOUT_ADDR = $D7DA  // @UXLOWOUT (address)
.var UA_LOWOUT_ADDR = $D7DA  // @UXLOWOUT (address)
.var MATH_UA_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var UA_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_UA_HIOUT_ADDR = $D7DA  // @UXHIOUT (address)
.var UA_HIOUT_ADDR = $D7DA  // @UXHIOUT (address)
.var MATH_UA_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var UA_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_UA_BSADD_ADDR = $D7DA  // @UXBSADD (address)
.var UA_BSADD_ADDR = $D7DA  // @UXBSADD (address)
.var MATH_UA_BSADD_MASK = 64  // @UXBSADD (bit mask)
.var UA_BSADD_MASK = 64  // @UXBSADD (bit mask)
.var MATH_UA_LATCH_ADDR = $D7DA  // @UXLATCH (address)
.var UA_LATCH_ADDR = $D7DA  // @UXLATCH (address)
.var MATH_UA_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var UA_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNITBOUT_ADDR = $D7DB  // @UNITXOUT (address)
.var UNITBOUT_ADDR = $D7DB  // @UNITXOUT (address)
.var MATH_UNITBOUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNITBOUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_UB_LOWOUT_ADDR = $D7DB  // @UXLOWOUT (address)
.var UB_LOWOUT_ADDR = $D7DB  // @UXLOWOUT (address)
.var MATH_UB_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var UB_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_UB_HIOUT_ADDR = $D7DB  // @UXHIOUT (address)
.var UB_HIOUT_ADDR = $D7DB  // @UXHIOUT (address)
.var MATH_UB_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var UB_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_UB_BSADD_ADDR = $D7DB  // @UXBSADD (address)
.var UB_BSADD_ADDR = $D7DB  // @UXBSADD (address)
.var MATH_UB_BSADD_MASK = 64  // @UXBSADD (bit mask)
.var UB_BSADD_MASK = 64  // @UXBSADD (bit mask)
.var MATH_UB_LATCH_ADDR = $D7DB  // @UXLATCH (address)
.var UB_LATCH_ADDR = $D7DB  // @UXLATCH (address)
.var MATH_UB_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var UB_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNITCOUT_ADDR = $D7DC  // @UNITXOUT (address)
.var UNITCOUT_ADDR = $D7DC  // @UNITXOUT (address)
.var MATH_UNITCOUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNITCOUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_UC_LOWOUT_ADDR = $D7DC  // @UXLOWOUT (address)
.var UC_LOWOUT_ADDR = $D7DC  // @UXLOWOUT (address)
.var MATH_UC_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var UC_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_UC_HIOUT_ADDR = $D7DC  // @UXHIOUT (address)
.var UC_HIOUT_ADDR = $D7DC  // @UXHIOUT (address)
.var MATH_UC_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var UC_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
...
.var MATH_UC_DVADD_MASK = 64  // If set, Math Function Unit X acts as a 32-bit adder instead of 32-bit divider. (bit mask)
.var UC_DVADD_MASK = 64  // If set, Math Function Unit X acts as a 32-bit adder instead of 32-bit divider. (bit mask)
.var MATH_UC_LATCH_ADDR = $D7DC  // @UXLATCH (address)
.var UC_LATCH_ADDR = $D7DC  // @UXLATCH (address)
.var MATH_UC_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var UC_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNITDOUT_ADDR = $D7DD  // @UNITXOUT (address)
.var UNITDOUT_ADDR = $D7DD  // @UNITXOUT (address)
.var MATH_UNITDOUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNITDOUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_UD_LOWOUT_ADDR = $D7DD  // @UXLOWOUT (address)
.var UD_LOWOUT_ADDR = $D7DD  // @UXLOWOUT (address)
.var MATH_UD_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var UD_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_UD_HIOUT_ADDR = $D7DD  // @UXHIOUT (address)
.var UD_HIOUT_ADDR = $D7DD  // @UXHIOUT (address)
.var MATH_UD_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var UD_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_UD_DVADD_ADDR = $D7DD  //  (address)
.var UD_DVADD_ADDR = $D7DD  //  (address)
.var MATH_UD_DVADD_MASK = 64  //  (bit mask)
.var UD_DVADD_MASK = 64  //  (bit mask)
.var MATH_UD_LATCH_ADDR = $D7DD  // @UXLATCH (address)
.var UD_LATCH_ADDR = $D7DD  // @UXLATCH (address)
.var MATH_UD_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var UD_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNITEOUT_ADDR = $D7DE  // @UNITXOUT (address)
.var UNITEOUT_ADDR = $D7DE  // @UNITXOUT (address)
.var MATH_UNITEOUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNITEOUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_UE_LOWOUT_ADDR = $D7DE  // @UXLOWOUT (address)
.var UE_LOWOUT_ADDR = $D7DE  // @UXLOWOUT (address)
.var MATH_UE_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var UE_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_UE_HIOUT_ADDR = $D7DE  // @UXHIOUT (address)
.var UE_HIOUT_ADDR = $D7DE  // @UXHIOUT (address)
.var MATH_UE_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var UE_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_UE_DVADD_ADDR = $D7DE  //  (address)
.var UE_DVADD_ADDR = $D7DE  //  (address)
.var MATH_UE_DVADD_MASK = 64  //  (bit mask)
.var UE_DVADD_MASK = 64  //  (bit mask)
.var MATH_UE_LATCH_ADDR = $D7DE  // @UXLATCH (address)
.var UE_LATCH_ADDR = $D7DE  // @UXLATCH (address)
.var MATH_UE_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var UE_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var MATH_UNITFOUT_ADDR = $D7DF  // @UNITXOUT (address)
.var UNITFOUT_ADDR = $D7DF  // @UNITXOUT (address)
.var MATH_UNITFOUT_MASK = 15  // @UNITXOUT (bit mask)
.var UNITFOUT_MASK = 15  // @UNITXOUT (bit mask)
.var MATH_UF_LOWOUT_ADDR = $D7DF  // @UXLOWOUT (address)
.var UF_LOWOUT_ADDR = $D7DF  // @UXLOWOUT (address)
.var MATH_UF_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var UF_LOWOUT_MASK = 16  // @UXLOWOUT (bit mask)
.var MATH_UF_HIOUT_ADDR = $D7DF  // @UXHIOUT (address)
.var UF_HIOUT_ADDR = $D7DF  // @UXHIOUT (address)
.var MATH_UF_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var UF_HIOUT_MASK = 32  // @UXHIOUT (bit mask)
.var MATH_UF_DVADD_ADDR = $D7DF  //  (address)
.var UF_DVADD_ADDR = $D7DF  //  (address)
.var MATH_UF_DVADD_MASK = 64  //  (bit mask)
.var UF_DVADD_MASK = 64  //  (bit mask)
.var MATH_UF_LATCH_ADDR = $D7DF  // @UXLATCH (address)
.var UF_LATCH_ADDR = $D7DF  // @UXLATCH (address)
.var MATH_UF_LATCH_MASK = 128  // @UXLATCH (bit mask)
.var UF_LATCH_MASK = 128  // @UXLATCH (bit mask)
...
.var MATH_WREN_MASK = 1  // Enable setting of math registers (must normally be set) (bit mask)
.var WREN_MASK = 1  // Enable setting of math registers (must normally be set) (bit mask)
...
.var MATH_CALCEN_MASK = 2  // Enable committing of output values from math units back to math registers (clearing effectively pauses iterative formulae) (bit mask)
.var CALCEN_MASK = 2  // Enable committing of output values from math units back to math registers (clearing effectively pauses iterative formulae) (bit mask)
...
.var CPU_IECBUSACT_MASK = 1  // IEC bus is active (bit mask)
.var IECBUSACT_MASK = 1  // IEC bus is active (bit mask)
...
.var CPU_CARTEN_MASK = 2  // 1= enable cartridges (bit mask)
.var CARTEN_MASK = 2  // 1= enable cartridges (bit mask)
...
.var CPU_POWEREN_MASK = 1  // Set to zero to power off computer on supported systems. WRITE ONLY. (bit mask)
.var POWEREN_MASK = 1  // Set to zero to power off computer on supported systems. WRITE ONLY. (bit mask)
...
.var CPU_NOGAME_MASK = 64  // Override for /GAME : Must be 0 to enable /GAME signal (bit mask)
.var NOGAME_MASK = 64  // Override for /GAME : Must be 0 to enable /GAME signal (bit mask)
...
.var CPU_NOEXROM_MASK = 128  // Override for /EXROM : Must be 0 to enable /EXROM signal (bit mask)
.var NOEXROM_MASK = 128  // Override for /EXROM : Must be 0 to enable /EXROM signal (bit mask)
...
.var CPU_PREFETCH_MASK = 1  // Enable expansion RAM pre-fetch logic (bit mask)
.var PREFETCH_MASK = 1  // Enable expansion RAM pre-fetch logic (bit mask)
...
.var CPU_OCEANA_MASK = 2  // Enable Ocean Type A cartridge emulation (bit mask)
.var OCEANA_MASK = 2  // Enable Ocean Type A cartridge emulation (bit mask)
...
.var GS_CIA1_TODJIF_MASK = 15  // TOD 10ths of seconds value (bit mask)
.var CIA1_IMTB_ADDR = $DC18  // Interrupt mask for Timer B (address)
.var CIA1_IMTB_MASK = 16  // Interrupt mask for Timer B (bit mask)
.var CIA1_IMALRM_ADDR = $DC18  // Interrupt mask for TOD alarm (address)
.var CIA1_IMALRM_MASK = 32  // Interrupt mask for TOD alarm (bit mask)
.var CIA1_IMSP_ADDR = $DC18  // Interrupt mask for shift register (serial port) (address)
.var CIA1_IMSP_MASK = 64  // Interrupt mask for shift register (serial port) (bit mask)
.var CIA1_IMFLG_ADDR = $DC18  // Interrupt mask for FLAG line (address)
.var CIA1_IMFLG_MASK = 128  // Interrupt mask for FLAG line (bit mask)
...
.var GS_CIA1_TODHOUR_MASK = 127  // TOD hours value (bit mask)
.var GS_CIA1_TODAMPM_ADDR = $DC1B  // TOD AM/PM flag (address)
.var GS_CIA1_TODAMPM_MASK = 128  // TOD AM/PM flag (bit mask)
...
.var CIA1_ALRMHOUR_MASK = 127  // TOD Alarm hours value (bit mask)
.var CIA1_ALRMAMPM_ADDR = $DC1F  // TOD Alarm AM/PM flag (address)
.var CIA1_ALRMAMPM_MASK = 128  // TOD Alarm AM/PM flag (bit mask)
...
.var GS_CIA2_TODJIF_MASK = 15  // TOD 10ths of seconds value (bit mask)
.var CIA2_IMTB_ADDR = $DD18  // Interrupt mask for Timer B (address)
.var CIA2_IMTB_MASK = 16  // Interrupt mask for Timer B (bit mask)
.var CIA2_IMALRM_ADDR = $DD18  // Interrupt mask for TOD alarm (address)
.var CIA2_IMALRM_MASK = 32  // Interrupt mask for TOD alarm (bit mask)
.var CIA2_IMSP_ADDR = $DD18  // Interrupt mask for shift register (serial port) (address)
.var CIA2_IMSP_MASK = 64  // Interrupt mask for shift register (serial port) (bit mask)
.var CIA2_IMFLG_ADDR = $DD18  // Interrupt mask for FLAG line (address)
.var CIA2_IMFLG_MASK = 128  // Interrupt mask for FLAG line (bit mask)
...
.var GS_CIA2_TODHOUR_MASK = 127  // TOD hours value (bit mask)
.var GS_CIA2_TODAMPM_ADDR = $DD1B  // TOD AM/PM flag (address)
.var GS_CIA2_TODAMPM_MASK = 128  // TOD AM/PM flag (bit mask)
...
.var CIA2_DD00DELAY_MASK = 128  // Enable delaying writes to $DD00 by 3 cycles to match real 6502 timing (bit mask)
.var DD00DELAY_MASK = 128  // Enable delaying writes to $DD00 by 3 cycles to match real 6502 timing (bit mask)
...
.var CIA2_ALRMHOUR_MASK = 127  // TOD Alarm hours value (bit mask)
.var CIA2_ALRMAMPM_ADDR = $DD1F  // TOD Alarm AM/PM flag (address)
.var CIA2_ALRMAMPM_MASK = 128  // TOD Alarm AM/PM flag (bit mask)
